.class public final Lpowerwatch/matrix/com/pwgen2android/shared/data/logPeriodsFormatters/RestingMonthPeriodFormatterImpl;
...
.annotation system Ldalvik/annotation/SourceDebugExtension;
    value = "SMAP\nRestingPeriodFormatters.kt\nKotlin\n*S Kotlin\n*F\n+ 1 RestingPeriodFormatters.kt\npowerwatch/matrix/com/pwgen2android/shared/data/logPeriodsFormatters/RestingMonthPeriodFormatterImpl\n+ 2 _Maps.kt\nkotlin/collections/MapsKt___MapsKt\n+ 3 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n*L\n1#1,109:1\n125#2:110\n152#2,2:111\n154#2:116\n1741#3,3:113\n*S KotlinDebug\n*F\n+ 1 RestingPeriodFormatters.kt\npowerwatch/matrix/com/pwgen2android/shared/data/logPeriodsFormatters/RestingMonthPeriodFormatterImpl\n*L\n91#1:110\n91#1:111,2\n91#1:116\n95#1:113,3\n*E\n"
.end annotation
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "Lpowerwatch/matrix/com/pwgen2android/shared/data/logPeriodsFormatters/RestingMonthPeriodFormatterImpl;",
        "Lpowerwatch/matrix/com/pwgen2android/shared/data/logPeriodsFormatters/AbstractPeriodFormatter;",
        "Lpowerwatch/matrix/com/pwgen2android/shared/data/models/RestingMonthPeriod;",
        "Lpowerwatch/matrix/com/pwgen2android/shared/data/models/RestingWeekPeriod;",
        "periods",
...
.method public constructor <init>(Ljava/util/List;)V
    ...
    iput-object p1, p0, Lpowerwatch/matrix/com/pwgen2android/shared/data/logPeriodsFormatters/RestingMonthPeriodFormatterImpl;->filler:Lpowerwatch/matrix/com/pwgen2android/shared/data/logPeriodsFormatters/RestingPeriodFillerImpl;
...
.method protected formatFromRecords(Ljava/util/List;)Ljava/util/List;
    ...
    .line 92
    iget-object v5, p0, Lpowerwatch/matrix/com/pwgen2android/shared/data/logPeriodsFormatters/RestingMonthPeriodFormatterImpl;->filler:Lpowerwatch/matrix/com/pwgen2android/shared/data/logPeriodsFormatters/RestingPeriodFillerImpl;

    invoke-virtual {p0}, Lpowerwatch/matrix/com/pwgen2android/shared/data/logPeriodsFormatters/RestingMonthPeriodFormatterImpl;->getEmptyPeriod()Lpowerwatch/matrix/com/pwgen2android/shared/data/models/RestingMonthPeriod;
    ...
    check-cast v5, Lpowerwatch/matrix/com/pwgen2android/shared/data/models/RestingMonthPeriod;
    ...
    invoke-virtual {v5, v6}, Lpowerwatch/matrix/com/pwgen2android/shared/data/models/RestingMonthPeriod;->setRestingWeeks(Ljava/util/List;)V

    .line 94
    invoke-virtual {v5}, Lpowerwatch/matrix/com/pwgen2android/shared/data/models/RestingMonthPeriod;->getStartTime()J
    ...
    invoke-virtual {v5, v6}, Lpowerwatch/matrix/com/pwgen2android/shared/data/models/RestingMonthPeriod;->setMonthInYear(I)V
    ...
    check-cast v6, Lpowerwatch/matrix/com/pwgen2android/shared/data/models/RestingWeekPeriod;

    .line 95
    invoke-virtual {v6}, Lpowerwatch/matrix/com/pwgen2android/shared/data/models/RestingWeekPeriod;->getMalformed()Z
    ...
    :goto_1
    invoke-virtual {v5, v4}, Lpowerwatch/matrix/com/pwgen2android/shared/data/models/RestingMonthPeriod;->setMalformed(Z)V
...
.method protected getEmptyPeriod()Lpowerwatch/matrix/com/pwgen2android/shared/data/models/RestingMonthPeriod;
    .locals 28

    .line 106
    new-instance v27, Lpowerwatch/matrix/com/pwgen2android/shared/data/models/RestingMonthPeriod;
    ...
    invoke-direct/range {v0 .. v26}, Lpowerwatch/matrix/com/pwgen2android/shared/data/models/RestingMonthPeriod;-><init>(JJFIIFFFFFFFIIILjava/util/List;JIFFFILkotlin/jvm/internal/DefaultConstructorMarker;)V
