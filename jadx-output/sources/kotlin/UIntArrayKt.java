...
public final class UIntArrayKt {
    ...
    private static final int[] UIntArray(int i, kotlin.jvm.functions.Function1<? super java.lang.Integer, kotlin.UInt> function1) {
        int[] iArr = new int[i];
        for (int i2 = 0; i2 < i; i2++) {
            iArr[i2] = function1.invoke(java.lang.Integer.valueOf(i2)).getData();
        }
        return kotlin.UIntArray.m161constructorimpl(iArr);
    }
}
