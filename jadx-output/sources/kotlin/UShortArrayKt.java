...
public final class UShortArrayKt {
    ...
    private static final short[] m359ushortArrayOfrL5Bavg(short... sArr) {
        return sArr;
    }

    private static final short[] UShortArray(int i, kotlin.jvm.functions.Function1<? super java.lang.Integer, kotlin.UShort> function1) {
        short[] sArr = new short[i];
        for (int i2 = 0; i2 < i; i2++) {
            sArr[i2] = function1.invoke(java.lang.Integer.valueOf(i2)).getData();
        }
        return kotlin.UShortArray.m343constructorimpl(sArr);
    }
}
