...
public final class UByteArrayKt {
    ...
    private static final byte[] UByteArray(int i, kotlin.jvm.functions.Function1<? super java.lang.Integer, kotlin.UByte> function1) {
        byte[] bArr = new byte[i];
        for (int i2 = 0; i2 < i; i2++) {
            bArr[i2] = function1.invoke(java.lang.Integer.valueOf(i2)).getData();
        }
        return kotlin.UByteArray.m83constructorimpl(bArr);
    }
}
