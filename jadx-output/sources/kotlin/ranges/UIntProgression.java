...
public class UIntProgression implements java.lang.Iterable<kotlin.UInt>, kotlin.jvm.internal.markers.KMappedMarker {
    ...
    private UIntProgression(int i, int i2, int i3) {
        ...
        this.first = i;
        this.last = kotlin.internal.UProgressionUtilKt.m1204getProgressionLastElementNkh28Cs(i, i2, i3);
        this.step = i3;
    }
    ...
    public java.lang.String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append(kotlin.UInt.m152toStringimpl(this.first));
            sb.append("..");
            sb.append(kotlin.UInt.m152toStringimpl(this.last));
            sb.append(" step ");
            i = this.step;
        } else {
            sb = new java.lang.StringBuilder();
    ...
    public static final class Companion {
        ...
        public final kotlin.ranges.UIntProgression m1220fromClosedRangeNkh28Cs(int rangeStart, int rangeEnd, int step) {
