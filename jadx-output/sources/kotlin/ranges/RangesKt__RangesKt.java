...
class RangesKt__RangesKt {
    public static final <T extends java.lang.Comparable<? super T>> kotlin.ranges.ClosedRange<T> rangeTo(T rangeTo, T that) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(rangeTo, "$this$rangeTo");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(that, "that");
        return new kotlin.ranges.ComparableRange(rangeTo, that);
    }
    ...
    private static final boolean contains(java.lang.Iterable contains, java.lang.Object obj) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return obj != null && ((kotlin.ranges.ClosedRange) contains).contains((java.lang.Comparable) obj);
    }
