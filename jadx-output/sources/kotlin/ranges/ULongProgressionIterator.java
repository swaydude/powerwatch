...
final class ULongProgressionIterator extends kotlin.collections.ULongIterator {
    ...
    private ULongProgressionIterator(long j, long j2, long j3) {
        ...
        boolean z = true;
        int iUlongCompare = kotlin.UnsignedKt.ulongCompare(j, j2);
        if (j3 <= 0 ? iUlongCompare < 0 : iUlongCompare > 0) {
            z = false;
        }
        this.hasNext = z;
        this.step = kotlin.ULong.m185constructorimpl(j3);
    ...
    public long mo254nextULongsVKNKU() {
        ...
        if (j == this.finalElement) {
            ...
            this.next = kotlin.ULong.m185constructorimpl(this.step + j);
        }
        return j;
    }
}
