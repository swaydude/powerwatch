...
public final class DeepRecursiveKt {
    ...
    public static final <T, R> R invoke(kotlin.DeepRecursiveFunction<T, R> invoke, T t) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(invoke, "$this$invoke");
        return (R) new kotlin.DeepRecursiveScopeImpl(invoke.getBlock$kotlin_stdlib(), t).runCallLoop();
    }

    static {
        kotlin.Result.Companion companion = kotlin.Result.INSTANCE;
        UNDEFINED_RESULT = kotlin.Result.m13constructorimpl(kotlin.coroutines.intrinsics.IntrinsicsKt.getCOROUTINE_SUSPENDED());
    }
}
