...
class ArraysKt__ArraysJVMKt {
    ...
    public static final /* synthetic */ <T> T[] toTypedArray(java.util.Collection<? extends T> toTypedArray) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(toTypedArray, "$this$toTypedArray");
        kotlin.jvm.internal.Intrinsics.reifiedOperationMarker(0, "T?");
        java.lang.Object[] array = toTypedArray.toArray(new java.lang.Object[0]);
    ...
    public static final <T> T[] arrayOfNulls(T[] reference, int i) {
        ...
        java.util.Objects.requireNonNull(objNewInstance, "null cannot be cast to non-null type kotlin.Array<T>");
