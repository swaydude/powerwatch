...
class CollectionsKt__IteratorsKt extends kotlin.collections.CollectionsKt__IteratorsJVMKt {
    ...
    private static final <T> java.util.Iterator<T> iterator(java.util.Iterator<? extends T> iterator) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(iterator, "$this$iterator");
        return iterator;
    }

    public static final <T> java.util.Iterator<kotlin.collections.IndexedValue<T>> withIndex(java.util.Iterator<? extends T> withIndex) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(withIndex, "$this$withIndex");
        return new kotlin.collections.IndexingIterator(withIndex);
    }

    public static final <T> void forEach(java.util.Iterator<? extends T> forEach, kotlin.jvm.functions.Function1<? super T, kotlin.Unit> operation) {
