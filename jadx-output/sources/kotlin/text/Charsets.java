...
public final class Charsets {
    ...
    static {
        ...
        kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(charsetForName, "Charset.forName(\"UTF-8\")");
        UTF_8 = charsetForName;
        java.nio.charset.Charset charsetForName2 = java.nio.charset.Charset.forName("UTF-16");
        kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(charsetForName2, "Charset.forName(\"UTF-16\")");
        UTF_16 = charsetForName2;
        java.nio.charset.Charset charsetForName3 = java.nio.charset.Charset.forName("UTF-16BE");
        kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(charsetForName3, "Charset.forName(\"UTF-16BE\")");
        UTF_16BE = charsetForName3;
        java.nio.charset.Charset charsetForName4 = java.nio.charset.Charset.forName("UTF-16LE");
        kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(charsetForName4, "Charset.forName(\"UTF-16LE\")");
        UTF_16LE = charsetForName4;
        java.nio.charset.Charset charsetForName5 = java.nio.charset.Charset.forName("US-ASCII");
        kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(charsetForName5, "Charset.forName(\"US-ASCII\")");
        US_ASCII = charsetForName5;
        java.nio.charset.Charset charsetForName6 = java.nio.charset.Charset.forName("ISO-8859-1");
        kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(charsetForName6, "Charset.forName(\"ISO-8859-1\")");
    ...
    public final java.nio.charset.Charset UTF32() {
        ...
        kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(charsetForName, "Charset.forName(\"UTF-32\")");
    ...
    public final java.nio.charset.Charset UTF32_LE() {
        ...
        kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(charsetForName, "Charset.forName(\"UTF-32LE\")");
    ...
    public final java.nio.charset.Charset UTF32_BE() {
        ...
        kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(charsetForName, "Charset.forName(\"UTF-32BE\")");
