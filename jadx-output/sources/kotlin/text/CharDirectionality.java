...
public enum CharDirectionality {
    ...
    private static final kotlin.Lazy directionalityMap$delegate = kotlin.LazyKt.lazy(new kotlin.jvm.functions.Function0<java.util.Map<java.lang.Integer, ? extends kotlin.text.CharDirectionality>>() { // from class: kotlin.text.CharDirectionality$Companion$directionalityMap$2
        @Override // kotlin.jvm.functions.Function0
        public final java.util.Map<java.lang.Integer, ? extends kotlin.text.CharDirectionality> invoke() {
            kotlin.text.CharDirectionality[] charDirectionalityArrValues = kotlin.text.CharDirectionality.values();
            java.util.LinkedHashMap linkedHashMap = new java.util.LinkedHashMap(kotlin.ranges.RangesKt.coerceAtLeast(kotlin.collections.MapsKt.mapCapacity(charDirectionalityArrValues.length), 16));
            for (kotlin.text.CharDirectionality charDirectionality : charDirectionalityArrValues) {
    ...
    public static final class Companion {
        private final java.util.Map<java.lang.Integer, kotlin.text.CharDirectionality> getDirectionalityMap() {
            kotlin.Lazy lazy = kotlin.text.CharDirectionality.directionalityMap$delegate;
            kotlin.text.CharDirectionality.Companion companion = kotlin.text.CharDirectionality.INSTANCE;
