...
class StringsKt__RegexExtensionsKt extends kotlin.text.StringsKt__RegexExtensionsJVMKt {
    ...
    private static final kotlin.text.Regex toRegex(java.lang.String str, kotlin.text.RegexOption regexOption) {
        return new kotlin.text.Regex(str, regexOption);
    }

    private static final kotlin.text.Regex toRegex(java.lang.String str, java.util.Set<? extends kotlin.text.RegexOption> set) {
        return new kotlin.text.Regex(str, set);
    }
}
