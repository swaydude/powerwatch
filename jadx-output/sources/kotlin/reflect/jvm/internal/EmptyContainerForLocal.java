...
public final class EmptyContainerForLocal extends kotlin.reflect.jvm.internal.KDeclarationContainerImpl {
    ...
    private final java.lang.Void fail() {
        throw new kotlin.reflect.jvm.internal.KotlinReflectionInternalError("Introspecting local functions, lambdas, anonymous functions and local variables is not yet fully supported in Kotlin reflection");
    }
}
