...
public final class DropWhileSequence<T> implements kotlin.sequences.Sequence<T> {
    ...
    public static final class AnonymousClass1 implements java.util.Iterator<T>, kotlin.jvm.internal.markers.KMappedMarker {
        ...
        AnonymousClass1() {
            this.iterator = kotlin.sequences.DropWhileSequence.this.sequence.iterator();
        }
        ...
        private final void drop() {
            while (this.iterator.hasNext()) {
                ...
                if (!((java.lang.Boolean) kotlin.sequences.DropWhileSequence.this.predicate.invoke(next)).booleanValue()) {
                    this.nextItem = next;
                    this.dropState = 1;
                    return;
                }
    ...
    public java.util.Iterator<T> iterator() {
        return new kotlin.sequences.DropWhileSequence.AnonymousClass1();
    }
}
