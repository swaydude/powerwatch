...
public final class TakeWhileSequence<T> implements kotlin.sequences.Sequence<T> {
    ...
    public static final class AnonymousClass1 implements java.util.Iterator<T>, kotlin.jvm.internal.markers.KMappedMarker {
        ...
        AnonymousClass1() {
            this.iterator = kotlin.sequences.TakeWhileSequence.this.sequence.iterator();
        }
        ...
        private final void calcNext() {
            if (this.iterator.hasNext()) {
                ...
                if (((java.lang.Boolean) kotlin.sequences.TakeWhileSequence.this.predicate.invoke(next)).booleanValue()) {
                    this.nextState = 1;
                    this.nextItem = next;
                    return;
                }
    ...
    public java.util.Iterator<T> iterator() {
        return new kotlin.sequences.TakeWhileSequence.AnonymousClass1();
    }
}
