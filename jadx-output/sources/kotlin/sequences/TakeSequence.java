...
public final class TakeSequence<T> implements kotlin.sequences.Sequence<T>, kotlin.sequences.DropTakeSequence<T> {
    ...
    public kotlin.sequences.Sequence<T> drop(int n) {
        int i = this.count;
        return n >= i ? kotlin.sequences.SequencesKt.emptySequence() : new kotlin.sequences.SubSequence(this.sequence, n, i);
    }
    ...
    public static final class AnonymousClass1 implements java.util.Iterator<T>, kotlin.jvm.internal.markers.KMappedMarker {
        ...
        AnonymousClass1() {
            this.left = kotlin.sequences.TakeSequence.this.count;
            this.iterator = kotlin.sequences.TakeSequence.this.sequence.iterator();
        }
    ...
    public java.util.Iterator<T> iterator() {
        return new kotlin.sequences.TakeSequence.AnonymousClass1();
    }
}
