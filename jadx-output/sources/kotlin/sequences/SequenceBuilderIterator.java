...
final class SequenceBuilderIterator<T> extends kotlin.sequences.SequenceScope<T> implements java.util.Iterator<T>, kotlin.coroutines.Continuation<kotlin.Unit>, kotlin.jvm.internal.markers.KMappedMarker {
    ...
    public boolean hasNext() throws java.lang.Throwable {
        while (true) {
            ...
            if (i != 0) {
                ...
                this.nextIterator = (java.util.Iterator) null;
            }
            this.state = 5;
            ...
            this.nextStep = (kotlin.coroutines.Continuation) null;
            kotlin.Unit unit = kotlin.Unit.INSTANCE;
            kotlin.Result.Companion companion = kotlin.Result.INSTANCE;
            continuation.resumeWith(kotlin.Result.m13constructorimpl(unit));
        }
    }
    ...
    public void resumeWith(java.lang.Object result) throws java.lang.Throwable {
