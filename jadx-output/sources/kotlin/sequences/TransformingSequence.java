...
public final class TransformingSequence<T, R> implements kotlin.sequences.Sequence<R> {
    ...
    public static final class AnonymousClass1 implements java.util.Iterator<R>, kotlin.jvm.internal.markers.KMappedMarker {
        ...
        AnonymousClass1() {
            this.iterator = kotlin.sequences.TransformingSequence.this.sequence.iterator();
        }
        ...
        @Override // java.util.Iterator
        public R next() {
            return (R) kotlin.sequences.TransformingSequence.this.transformer.invoke(this.iterator.next());
        }
    ...
    public java.util.Iterator<R> iterator() {
        return new kotlin.sequences.TransformingSequence.AnonymousClass1();
    }
