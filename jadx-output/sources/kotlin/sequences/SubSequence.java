...
public final class SubSequence<T> implements kotlin.sequences.Sequence<T>, kotlin.sequences.DropTakeSequence<T> {
    ...
    public static final class AnonymousClass1 implements java.util.Iterator<T>, kotlin.jvm.internal.markers.KMappedMarker {
        ...
        AnonymousClass1() {
            this.iterator = kotlin.sequences.SubSequence.this.sequence.iterator();
        }
        ...
        private final void drop() {
            while (this.position < kotlin.sequences.SubSequence.this.startIndex && this.iterator.hasNext()) {
                this.iterator.next();
                this.position++;
            }
        }
        ...
        public boolean hasNext() {
            drop();
            return this.position < kotlin.sequences.SubSequence.this.endIndex && this.iterator.hasNext();
        }

        @Override // java.util.Iterator
        public T next() {
            drop();
            if (this.position >= kotlin.sequences.SubSequence.this.endIndex) {
    ...
    public java.util.Iterator<T> iterator() {
        return new kotlin.sequences.SubSequence.AnonymousClass1();
    }
}
