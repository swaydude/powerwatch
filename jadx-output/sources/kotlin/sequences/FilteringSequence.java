...
public final class FilteringSequence<T> implements kotlin.sequences.Sequence<T> {
    ...
    public static final class AnonymousClass1 implements java.util.Iterator<T>, kotlin.jvm.internal.markers.KMappedMarker {
        ...
        AnonymousClass1() {
            this.iterator = kotlin.sequences.FilteringSequence.this.sequence.iterator();
        }
        ...
        private final void calcNext() {
            while (this.iterator.hasNext()) {
                ...
                if (((java.lang.Boolean) kotlin.sequences.FilteringSequence.this.predicate.invoke(next)).booleanValue() == kotlin.sequences.FilteringSequence.this.sendWhen) {
                    this.nextItem = next;
                    this.nextState = 1;
                    return;
                }
    ...
    public java.util.Iterator<T> iterator() {
        return new kotlin.sequences.FilteringSequence.AnonymousClass1();
    }
}
