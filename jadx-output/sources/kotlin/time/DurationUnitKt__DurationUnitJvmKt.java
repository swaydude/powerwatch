...
class DurationUnitKt__DurationUnitJvmKt {
    ...
    public static final double convertDurationUnit(double d, java.util.concurrent.TimeUnit sourceUnit, java.util.concurrent.TimeUnit targetUnit) {
    ...
    public static final long convertDurationUnitOverflow(long j, java.util.concurrent.TimeUnit sourceUnit, java.util.concurrent.TimeUnit targetUnit) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(sourceUnit, "sourceUnit");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(targetUnit, "targetUnit");
        return targetUnit.convert(j, sourceUnit);
    }

    public static final long convertDurationUnit(long j, java.util.concurrent.TimeUnit sourceUnit, java.util.concurrent.TimeUnit targetUnit) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(sourceUnit, "sourceUnit");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(targetUnit, "targetUnit");
        return targetUnit.convert(j, sourceUnit);
    }
