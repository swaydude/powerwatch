...
public abstract class AbstractLongTimeSource implements kotlin.time.TimeSource {
    ...
    public AbstractLongTimeSource(java.util.concurrent.TimeUnit unit) {
    ...
    private static final class LongTimeMark extends kotlin.time.TimeMark {
        ...
        public kotlin.time.TimeMark mo1303plusLRDsOJo(long duration) {
            return new kotlin.time.AbstractLongTimeSource.LongTimeMark(this.startedAt, this.timeSource, kotlin.time.Duration.m1347plusLRDsOJo(this.offset, duration));
        }
    }

    @Override // kotlin.time.TimeSource
    public kotlin.time.TimeMark markNow() {
        return new kotlin.time.AbstractLongTimeSource.LongTimeMark(read(), this, kotlin.time.Duration.INSTANCE.m1372getZEROUwyO8pc(), null);
    }
}
