...
public abstract class AbstractDoubleTimeSource implements kotlin.time.TimeSource {
    ...
    public AbstractDoubleTimeSource(java.util.concurrent.TimeUnit unit) {
    ...
    private static final class DoubleTimeMark extends kotlin.time.TimeMark {
        ...
        public long mo1302elapsedNowUwyO8pc() {
            return kotlin.time.Duration.m1346minusLRDsOJo(kotlin.time.DurationKt.toDuration(this.timeSource.read() - this.startedAt, this.timeSource.getUnit()), this.offset);
        }

        @Override // kotlin.time.TimeMark
        /* JADX INFO: renamed from: plus-LRDsOJo, reason: not valid java name */
        public kotlin.time.TimeMark mo1303plusLRDsOJo(long duration) {
            return new kotlin.time.AbstractDoubleTimeSource.DoubleTimeMark(this.startedAt, this.timeSource, kotlin.time.Duration.m1347plusLRDsOJo(this.offset, duration));
        }
    }

    @Override // kotlin.time.TimeSource
    public kotlin.time.TimeMark markNow() {
        return new kotlin.time.AbstractDoubleTimeSource.DoubleTimeMark(read(), this, kotlin.time.Duration.INSTANCE.m1372getZEROUwyO8pc(), null);
    }
}
