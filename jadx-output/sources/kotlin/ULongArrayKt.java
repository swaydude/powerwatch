...
public final class ULongArrayKt {
    ...
    private static final long[] m255ulongArrayOfQwZRm1k(long... jArr) {
        return jArr;
    }

    private static final long[] ULongArray(int i, kotlin.jvm.functions.Function1<? super java.lang.Integer, kotlin.ULong> function1) {
        long[] jArr = new long[i];
        for (int i2 = 0; i2 < i; i2++) {
            jArr[i2] = function1.invoke(java.lang.Integer.valueOf(i2)).getData();
        }
        return kotlin.ULongArray.m239constructorimpl(jArr);
    }
}
