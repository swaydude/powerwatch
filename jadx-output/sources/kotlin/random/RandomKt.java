...
public final class RandomKt {
    ...
    public static final int nextInt(kotlin.random.Random nextInt, kotlin.ranges.IntRange range) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(nextInt, "$this$nextInt");
    ...
    public static final long nextLong(kotlin.random.Random nextLong, kotlin.ranges.LongRange range) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(nextLong, "$this$nextLong");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(range, "range");
        if (!range.isEmpty()) {
            if (range.getLast() < kotlin.jvm.internal.LongCompanionObject.MAX_VALUE) {
