...
public final class WalkingLogServiceImpl implements powerwatch.matrix.com.pwgen2android.shared.cloud.crudServices.WalkingLogService, powerwatch.matrix.com.pwgen2android.shared.cloud.crudServices.AddService<java.util.List<? extends powerwatch.matrix.com.pwgen2android.shared.data.logPeriodsFormatters.WalkingLog>> {
    ...
    public /* bridge */ /* synthetic */ io.reactivex.Completable add(java.util.List<? extends powerwatch.matrix.com.pwgen2android.shared.data.logPeriodsFormatters.WalkingLog> list, java.util.Map map) {
        return add2((java.util.List<powerwatch.matrix.com.pwgen2android.shared.data.logPeriodsFormatters.WalkingLog>) list, (java.util.Map<java.lang.String, java.lang.String>) map);
    }

    public /* synthetic */ WalkingLogServiceImpl(powerwatch.matrix.com.pwgen2android.shared.cloud.http.HttpClient httpClient, powerwatch.matrix.com.pwgen2android.shared.cloud.activityLogs.LogCloudConfig logCloudConfig, powerwatch.matrix.com.pwgen2android.shared.cloud.crudServices.AddServiceImpl addServiceImpl, int i, kotlin.jvm.internal.DefaultConstructorMarker defaultConstructorMarker) {
