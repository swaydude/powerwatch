...
public final class SleepDayPeriodDataProviderImpl extends powerwatch.matrix.com.pwgen2android.shared.data.providers.activities.BaseActivityDataProvider<powerwatch.matrix.com.pwgen2android.shared.data.models.SleepDayPeriod> implements powerwatch.matrix.com.pwgen2android.shared.data.providers.activities.day.SleepDayPeriodDataProvider {
    ...
    public java.util.List<powerwatch.matrix.com.pwgen2android.shared.data.models.SleepDayPeriod> getPeriods(powerwatch.matrix.com.pwgen2android.shared.sync.PeriodsContainer periodsContainer) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(periodsContainer, "periodsContainer");
        return periodsContainer.getSleepDayPeriods();
    }
}
