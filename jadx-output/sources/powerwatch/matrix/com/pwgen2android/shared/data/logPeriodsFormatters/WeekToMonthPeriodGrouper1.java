...
@kotlin.Metadata(d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0000\u0018\u0000*\b\b\u0000\u0010\u0001*\u00020\u00022\b\u0012\u0004\u0012\u0002H\u00010\u0003B\u000f\u0012\b\b\u0002\u0010\u0004\u001a\u00020\u0005¢\u0006\u0002\u0010\u0006J\u0010\u0010\u0007\u001a\u00020\b2\u0006\u0010\t\u001a\u00020\nH\u0016R\u000e\u0010\u0004\u001a\u00020\u0005X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u000b"}, d2 = {"Lpowerwatch/matrix/com/pwgen2android/shared/data/logPeriodsFormatters/WeekToMonthPeriodGrouper1;", "T", "Lpowerwatch/matrix/com/pwgen2android/shared/data/models/BaseTimePeriod;", "Lpowerwatch/matrix/com/pwgen2android/shared/data/logPeriodsFormatters/PeriodGrouper1;", "offset", "", "(I)V", "groupCriteria", "", "cal", "Ljava/util/Calendar;", "app_release"}, k = 1, mv = {1, 5, 1}, xi = 48)
public final class WeekToMonthPeriodGrouper1<T extends powerwatch.matrix.com.pwgen2android.shared.data.models.BaseTimePeriod> implements powerwatch.matrix.com.pwgen2android.shared.data.logPeriodsFormatters.PeriodGrouper1<T> {
    private final int offset;

    public WeekToMonthPeriodGrouper1() {
        this(0, 1, null);
    }

    public WeekToMonthPeriodGrouper1(int i) {
        this.offset = i;
    }

    public /* synthetic */ WeekToMonthPeriodGrouper1(int i, int i2, kotlin.jvm.internal.DefaultConstructorMarker defaultConstructorMarker) {
        this((i2 & 1) != 0 ? 0 : i);
    }
    ...
    public java.lang.String groupCriteria(java.util.Calendar cal) {
        ...
        return powerwatch.matrix.com.pwgen2android.shared.extensions.DateTimeExtensionsKt.monthUniqueID(cal);
    }
}
