    ...
    public final java.util.List<powerwatch.matrix.com.pwgen2android.shared.data.logPeriodsFormatters.RestingLog> format(java.util.List<powerwatch.matrix.com.pwgen2android.sdk.protocol.commands.WatchLogEntry> watchLogEntries, powerwatch.matrix.com.pwgen2android.sdk.protocol.commands.TotalActivityData totalDisplayedData, long logInterval, boolean isGen2) {
        ...
        for (java.lang.Object obj : list) {
            ...
            if (watchLogEntry.getWalkingSteps() != 0 || watchLogEntry.isSleep()) {
                ...
                restingLog = new powerwatch.matrix.com.pwgen2android.shared.data.logPeriodsFormatters.RestingLog(j2, j3, pulseCount, watchLogEntry.getWatchPowerLog().getThermalGen(), watchLogEntry.getWatchPowerLog().getSolarGen(), watchLogEntry.getWatchPowerLog().getSkinTemp(), 0.0f, 0.0f, watchLogEntry.getWatchPowerLog().getCaseTemp(), 0.0f, 0.0f, watchLogEntry.getActiveCalories() * i, watchLogEntry.getHrv(), false, watchLogEntry.getBmrCalories() * i, pulseCount2, pulseCount3, null, iRoundToInt, 140992, null);
            }
