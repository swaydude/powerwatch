...
public final /* data */ class SleepMonthPeriod implements powerwatch.matrix.com.pwgen2android.shared.data.models.SleepBasePeriod {
    ...
    private java.util.List<powerwatch.matrix.com.pwgen2android.shared.data.models.SleepWeekPeriod> sleepWeeks;
    private float solarPower;
    private long startTime;

    public SleepMonthPeriod() {
    ...
    public final java.util.List<powerwatch.matrix.com.pwgen2android.shared.data.models.SleepWeekPeriod> component16() {
    ...
    public final powerwatch.matrix.com.pwgen2android.shared.data.models.SleepMonthPeriod copy(long startTime, long endTime, float heartRate, int maxHeartRate, int minHeartRate, float hrv, float skinTemp, float maxSkinTemp, float minSkinTemp, float bodyPower, float solarPower, float peakTemp, int monthInYear, int activeCalories, int minsInPeriod, java.util.List<powerwatch.matrix.com.pwgen2android.shared.data.models.SleepWeekPeriod> sleepWeeks, long lastUpdated, int bmrCalories, float caseTemp, int restlessMinutes, float minCaseTemp, float maxCaseTemp, powerwatch.matrix.com.pwgen2android.shared.data.models.SleepType sleepType) {
        ...
        return new powerwatch.matrix.com.pwgen2android.shared.data.models.SleepMonthPeriod(startTime, endTime, heartRate, maxHeartRate, minHeartRate, hrv, skinTemp, maxSkinTemp, minSkinTemp, bodyPower, solarPower, peakTemp, monthInYear, activeCalories, minsInPeriod, sleepWeeks, lastUpdated, bmrCalories, caseTemp, restlessMinutes, minCaseTemp, maxCaseTemp, sleepType);
    }
    ...
    public boolean equals(java.lang.Object other) {
        ...
        if (!(other instanceof powerwatch.matrix.com.pwgen2android.shared.data.models.SleepMonthPeriod)) {
            return false;
        }
        powerwatch.matrix.com.pwgen2android.shared.data.models.SleepMonthPeriod sleepMonthPeriod = (powerwatch.matrix.com.pwgen2android.shared.data.models.SleepMonthPeriod) other;
        return getStartTime() == sleepMonthPeriod.getStartTime() && getEndTime() == sleepMonthPeriod.getEndTime() && kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) java.lang.Float.valueOf(getHeartRate()), (java.lang.Object) java.lang.Float.valueOf(sleepMonthPeriod.getHeartRate())) && getMaxHeartRate() == sleepMonthPeriod.getMaxHeartRate() && getMinHeartRate() == sleepMonthPeriod.getMinHeartRate() && kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) java.lang.Float.valueOf(getHrv()), (java.lang.Object) java.lang.Float.valueOf(sleepMonthPeriod.getHrv())) && kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) java.lang.Float.valueOf(getSkinTemp()), (java.lang.Object) java.lang.Float.valueOf(sleepMonthPeriod.getSkinTemp())) && kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) java.lang.Float.valueOf(getMaxSkinTemp()), (java.lang.Object) java.lang.Float.valueOf(sleepMonthPeriod.getMaxSkinTemp())) && kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) java.lang.Float.valueOf(getMinSkinTemp()), (java.lang.Object) java.lang.Float.valueOf(sleepMonthPeriod.getMinSkinTemp())) && kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) java.lang.Float.valueOf(getBodyPower()), (java.lang.Object) java.lang.Float.valueOf(sleepMonthPeriod.getBodyPower())) && kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) java.lang.Float.valueOf(getSolarPower()), (java.lang.Object) java.lang.Float.valueOf(sleepMonthPeriod.getSolarPower())) && kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) java.lang.Float.valueOf(getPeakTemp()), (java.lang.Object) java.lang.Float.valueOf(sleepMonthPeriod.getPeakTemp())) && this.monthInYear == sleepMonthPeriod.monthInYear && getActiveCalories() == sleepMonthPeriod.getActiveCalories() && getMinsInPeriod() == sleepMonthPeriod.getMinsInPeriod() && kotlin.jvm.internal.Intrinsics.areEqual(this.sleepWeeks, sleepMonthPeriod.sleepWeeks) && getLastUpdated() == sleepMonthPeriod.getLastUpdated() && getBmrCalories() == sleepMonthPeriod.getBmrCalories() && kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) java.lang.Float.valueOf(getCaseTemp()), (java.lang.Object) java.lang.Float.valueOf(sleepMonthPeriod.getCaseTemp())) && getRestlessMinutes() == sleepMonthPeriod.getRestlessMinutes() && kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) java.lang.Float.valueOf(getMinCaseTemp()), (java.lang.Object) java.lang.Float.valueOf(sleepMonthPeriod.getMinCaseTemp())) && kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) java.lang.Float.valueOf(getMaxCaseTemp()), (java.lang.Object) java.lang.Float.valueOf(sleepMonthPeriod.getMaxCaseTemp())) && getSleepType() == sleepMonthPeriod.getSleepType();
    }

    public int hashCode() {
        return (((((((((((((((((((((((((((((((((((((((((((powerwatch.matrix.com.pwgen2android.googlefit.GoogleFitDataWriter$SleepSession$$ExternalSynthetic0.m0(getStartTime()) * 31) + powerwatch.matrix.com.pwgen2android.googlefit.GoogleFitDataWriter$SleepSession$$ExternalSynthetic0.m0(getEndTime())) * 31) + java.lang.Float.floatToIntBits(getHeartRate())) * 31) + getMaxHeartRate()) * 31) + getMinHeartRate()) * 31) + java.lang.Float.floatToIntBits(getHrv())) * 31) + java.lang.Float.floatToIntBits(getSkinTemp())) * 31) + java.lang.Float.floatToIntBits(getMaxSkinTemp())) * 31) + java.lang.Float.floatToIntBits(getMinSkinTemp())) * 31) + java.lang.Float.floatToIntBits(getBodyPower())) * 31) + java.lang.Float.floatToIntBits(getSolarPower())) * 31) + java.lang.Float.floatToIntBits(getPeakTemp())) * 31) + this.monthInYear) * 31) + getActiveCalories()) * 31) + getMinsInPeriod()) * 31) + this.sleepWeeks.hashCode()) * 31) + powerwatch.matrix.com.pwgen2android.googlefit.GoogleFitDataWriter$SleepSession$$ExternalSynthetic0.m0(getLastUpdated())) * 31) + getBmrCalories()) * 31) + java.lang.Float.floatToIntBits(getCaseTemp())) * 31) + getRestlessMinutes()) * 31) + java.lang.Float.floatToIntBits(getMinCaseTemp())) * 31) + java.lang.Float.floatToIntBits(getMaxCaseTemp())) * 31) + getSleepType().hashCode();
    }

    public java.lang.String toString() {
        return "SleepMonthPeriod(startTime=" + getStartTime() + ", endTime=" + getEndTime() + ", heartRate=" + getHeartRate() + ", maxHeartRate=" + getMaxHeartRate() + ", minHeartRate=" + getMinHeartRate() + ", hrv=" + getHrv() + ", skinTemp=" + getSkinTemp() + ", maxSkinTemp=" + getMaxSkinTemp() + ", minSkinTemp=" + getMinSkinTemp() + ", bodyPower=" + getBodyPower() + ", solarPower=" + getSolarPower() + ", peakTemp=" + getPeakTemp() + ", monthInYear=" + this.monthInYear + ", activeCalories=" + getActiveCalories() + ", minsInPeriod=" + getMinsInPeriod() + ", sleepWeeks=" + this.sleepWeeks + ", lastUpdated=" + getLastUpdated() + ", bmrCalories=" + getBmrCalories() + ", caseTemp=" + getCaseTemp() + ", restlessMinutes=" + getRestlessMinutes() + ", minCaseTemp=" + getMinCaseTemp() + ", maxCaseTemp=" + getMaxCaseTemp() + ", sleepType=" + getSleepType() + ')';
    }

    public SleepMonthPeriod(long j, long j2, float f, int i, int i2, float f2, float f3, float f4, float f5, float f6, float f7, float f8, int i3, int i4, int i5, java.util.List<powerwatch.matrix.com.pwgen2android.shared.data.models.SleepWeekPeriod> sleepWeeks, long j3, int i6, float f9, int i7, float f10, float f11, powerwatch.matrix.com.pwgen2android.shared.data.models.SleepType sleepType) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(sleepWeeks, "sleepWeeks");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(sleepType, "sleepType");
        this.startTime = j;
        this.endTime = j2;
    ...
    public final void setSleepWeeks(java.util.List<powerwatch.matrix.com.pwgen2android.shared.data.models.SleepWeekPeriod> list) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(list, "<set-?>");
        this.sleepWeeks = list;
    }
