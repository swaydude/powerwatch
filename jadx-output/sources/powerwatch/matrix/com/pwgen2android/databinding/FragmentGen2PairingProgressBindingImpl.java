...
public class FragmentGen2PairingProgressBindingImpl extends powerwatch.matrix.com.pwgen2android.databinding.FragmentGen2PairingProgressBinding {
    ...
    private powerwatch.matrix.com.pwgen2android.databinding.FragmentGen2PairingProgressBindingImpl.OnClickListenerImpl mViewModelOnBluetoothEnableClickedAndroidViewViewOnClickListener;
    ...
    public FragmentGen2PairingProgressBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, android.view.View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 5, sIncludes, sViewsWithIds));
    }

    private FragmentGen2PairingProgressBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, android.view.View root, java.lang.Object[] bindings) {
    ...
    public boolean setVariable(int variableId, java.lang.Object variable) {
        ...
        setViewModel((powerwatch.matrix.com.pwgen2android.pair.ui.gen2.Gen2PairingProgressViewModel) variable);
        return true;
    }

    @Override // powerwatch.matrix.com.pwgen2android.databinding.FragmentGen2PairingProgressBinding
    public void setViewModel(powerwatch.matrix.com.pwgen2android.pair.ui.gen2.Gen2PairingProgressViewModel ViewModel) {
    ...
    protected void executeBindings() {
        long j;
        powerwatch.matrix.com.pwgen2android.databinding.FragmentGen2PairingProgressBindingImpl.OnClickListenerImpl value;
        ...
        powerwatch.matrix.com.pwgen2android.pair.ui.gen2.Gen2PairingProgressViewModel gen2PairingProgressViewModel = this.mViewModel;
        boolean zSafeUnbox = false;
        if ((31 & j) != 0) {
            if ((j & 24) == 0 || gen2PairingProgressViewModel == null) {
                value = null;
            } else {
                powerwatch.matrix.com.pwgen2android.databinding.FragmentGen2PairingProgressBindingImpl.OnClickListenerImpl onClickListenerImpl = this.mViewModelOnBluetoothEnableClickedAndroidViewViewOnClickListener;
                if (onClickListenerImpl == null) {
                    onClickListenerImpl = new powerwatch.matrix.com.pwgen2android.databinding.FragmentGen2PairingProgressBindingImpl.OnClickListenerImpl();
                    this.mViewModelOnBluetoothEnableClickedAndroidViewViewOnClickListener = onClickListenerImpl;
                }
                value = onClickListenerImpl.setValue(gen2PairingProgressViewModel);
            }
            if ((j & 25) != 0) {
                androidx.databinding.ObservableField<java.lang.Boolean> bluetoothWarnDisplayed = gen2PairingProgressViewModel != null ? gen2PairingProgressViewModel.getBluetoothWarnDisplayed() : null;
            ...
            if ((j & 26) == 0) {
                ...
                androidx.databinding.ObservableField<java.lang.String> pairingProgressText = gen2PairingProgressViewModel != null ? gen2PairingProgressViewModel.getPairingProgressText() : null;
            ...
            if ((j & 28) != 0) {
                pairingProgressField = gen2PairingProgressViewModel != null ? gen2PairingProgressViewModel.getPairingProgressField() : null;
    ...
    public static class OnClickListenerImpl implements android.view.View.OnClickListener {
        private powerwatch.matrix.com.pwgen2android.pair.ui.gen2.Gen2PairingProgressViewModel value;

        public powerwatch.matrix.com.pwgen2android.databinding.FragmentGen2PairingProgressBindingImpl.OnClickListenerImpl setValue(powerwatch.matrix.com.pwgen2android.pair.ui.gen2.Gen2PairingProgressViewModel value) {
            this.value = value;
            if (value == null) {
                return null;
            }
