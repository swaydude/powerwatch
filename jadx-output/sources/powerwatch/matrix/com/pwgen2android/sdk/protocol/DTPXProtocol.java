...
public final class DTPXProtocol implements powerwatch.matrix.com.pwgen2android.sdk.protocol.Protocol {
    ...
    public DTPXProtocol(powerwatch.matrix.com.pwgen2android.sdk.protocol.Protocol bleProtocolImpl) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(bleProtocolImpl, "bleProtocolImpl");
        this.bleProtocolImpl = bleProtocolImpl;
    }

    public /* synthetic */ DTPXProtocol(powerwatch.matrix.com.pwgen2android.sdk.protocol.ProtocolImpl protocolImpl, int i, kotlin.jvm.internal.DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public powerwatch.matrix.com.pwgen2android.sdk.protocol.ProtocolType getType() {
        return powerwatch.matrix.com.pwgen2android.sdk.protocol.ProtocolType.BLE_DTP_X;
    }
    ...
    public io.reactivex.Completable connectToChannel(powerwatch.matrix.com.pwgen2android.sdk.channels.CommunicationChannel channel) {
        ...
        io.reactivex.Completable completableAndThen = this.bleProtocolImpl.connectToChannel(channel).andThen(sendMessage(new powerwatch.matrix.com.pwgen2android.sdk.model.ProtocolMessage(new powerwatch.matrix.com.pwgen2android.sdk.model.ProtocolPayload(new byte[]{-124, 66, 1}), getType(), powerwatch.matrix.com.pwgen2android.sdk.protocol.ProtocolMessageType.SETTING)).ignoreElement());
        kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(completableAndThen, "bleProtocolImpl\n                .connectToChannel(channel)\n                .andThen(\n                        sendMessage(ProtocolMessage(ProtocolPayload(byteArrayOf(0x84.toByte(), 0x42, 0x01)), getType(), ProtocolMessageType.SETTING))\n                                .ignoreElement()\n                )");
