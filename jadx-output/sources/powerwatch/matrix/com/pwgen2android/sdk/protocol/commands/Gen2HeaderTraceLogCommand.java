...
public final class Gen2HeaderTraceLogCommand extends powerwatch.matrix.com.pwgen2android.sdk.protocol.commands.Gen2AbstractCommand {
    ...
    public Gen2HeaderTraceLogCommand() {
        ...
        this.logger = kotlin.LazyKt.lazy(new kotlin.jvm.functions.Function0<powerwatch.matrix.com.pwgen2android.sdk.protocol.commands.TraceLogger>() { // from class: powerwatch.matrix.com.pwgen2android.sdk.protocol.commands.Gen2HeaderTraceLogCommand$special$$inlined$inject$default$1
    ...
    public powerwatch.matrix.com.pwgen2android.sdk.protocol.commands.Gen2DataInfo extractResponse(byte[] payloadData, powerwatch.matrix.com.pwgen2android.sdk.protocol.commands.Gen2DataInfo dataInfo) {
        ...
        java.lang.System.out.println((java.lang.Object) kotlin.jvm.internal.Intrinsics.stringPlus("Data received in Header Trace Log: ", powerwatch.matrix.com.pwgen2android.shared.extensions.BluetoothExtensionsKt.formatToString(payloadData, false)));
        getLogger().log(powerwatch.matrix.com.pwgen2android.shared.extensions.BluetoothExtensionsKt.formatToString(payloadData, false), powerwatch.matrix.com.pwgen2android.sdk.protocol.commands.LogDataType.Header.INSTANCE);
        return dataInfo;
    }
}
