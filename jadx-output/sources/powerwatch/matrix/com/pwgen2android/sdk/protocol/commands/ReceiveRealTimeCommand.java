...
@kotlin.Metadata(d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0012\n\u0002\b\u0002\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\u0018\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\u0004H\u0016¨\u0006\b"}, d2 = {"Lpowerwatch/matrix/com/pwgen2android/sdk/protocol/commands/ReceiveRealTimeCommand;", "Lpowerwatch/matrix/com/pwgen2android/sdk/protocol/commands/Gen2AbstractCommand;", "()V", "extractResponse", "Lpowerwatch/matrix/com/pwgen2android/sdk/protocol/commands/Gen2DataInfo;", "payloadData", "", "dataInfo", "app_release"}, k = 1, mv = {1, 5, 1}, xi = 48)
public final class ReceiveRealTimeCommand extends powerwatch.matrix.com.pwgen2android.sdk.protocol.commands.Gen2AbstractCommand {
    public ReceiveRealTimeCommand() {
        super(powerwatch.matrix.com.pwgen2android.sdk.protocol.commands.Gen2CommandIDs.ReceiveRealTimeCommandId.INSTANCE);
    }
    ...
    public powerwatch.matrix.com.pwgen2android.sdk.protocol.commands.Gen2DataInfo extractResponse(byte[] payloadData, powerwatch.matrix.com.pwgen2android.sdk.protocol.commands.Gen2DataInfo dataInfo) {
        ...
        kotlin.UInt.m107constructorimpl(byteBufferWrap.getInt());
        ...
        powerwatch.matrix.com.pwgen2android.sdk.protocol.commands.TotalActivityData activitySummary = dataInfo.getDataInfo().getActivitySummary();
        powerwatch.matrix.com.pwgen2android.sdk.protocol.commands.TotalActivityData totalActivityDataCopy = activitySummary.copy((1 & 1) != 0 ? activitySummary.lastLogTime : 0L, (1 & 2) != 0 ? activitySummary.steps : jM107constructorimpl, (1 & 4) != 0 ? activitySummary.distance : jM107constructorimpl2, (1 & 8) != 0 ? activitySummary.calories : i);
        dataInfo.getDataInfo().setParsingFinished(true);
        dataInfo.getDataInfo().setParsingStarted(false);
        dataInfo.getDataInfo().setActivitySummary(totalActivityDataCopy);
        return dataInfo;
    }
}
