...
public final class ReadGoalsCommand implements powerwatch.matrix.com.pwgen2android.sdk.protocol.commands.Command {
    ...
    public powerwatch.matrix.com.pwgen2android.sdk.protocol.commands.DataInfo parseReceivedData(byte[] dataToParse, powerwatch.matrix.com.pwgen2android.sdk.protocol.commands.DataInfo dataInfo) {
        ...
        if (!kotlin.text.StringsKt.startsWith(str, "#QT:Q,3", true)) {
            return dataInfo;
        }
        ...
        if (listSplit$default.size() >= 6) {
            return dataInfo.copy((com.baidu.mapapi.UIMsg.d_ResultType.LONG_URL & 1) != 0 ? dataInfo.parsingStarted : false, (com.baidu.mapapi.UIMsg.d_ResultType.LONG_URL & 2) != 0 ? dataInfo.parsingFinished : true, (com.baidu.mapapi.UIMsg.d_ResultType.LONG_URL & 4) != 0 ? dataInfo.data : null, (com.baidu.mapapi.UIMsg.d_ResultType.LONG_URL & 8) != 0 ? dataInfo.dataToProcess : 0.0f, (com.baidu.mapapi.UIMsg.d_ResultType.LONG_URL & 16) != 0 ? dataInfo.activityLogs : null, (com.baidu.mapapi.UIMsg.d_ResultType.LONG_URL & 32) != 0 ? dataInfo.runningLogs : null, (com.baidu.mapapi.UIMsg.d_ResultType.LONG_URL & 64) != 0 ? dataInfo.activitySummary : new powerwatch.matrix.com.pwgen2android.sdk.protocol.commands.TotalActivityData(java.lang.Long.parseLong((java.lang.String) listSplit$default.get(2)) * ((long) 1000), java.lang.Long.parseLong((java.lang.String) listSplit$default.get(3)), java.lang.Long.parseLong((java.lang.String) listSplit$default.get(4)), java.lang.Integer.parseInt(new kotlin.text.Regex("\n").split((java.lang.CharSequence) listSplit$default.get(5), 0).get(0))), (com.baidu.mapapi.UIMsg.d_ResultType.LONG_URL & 128) != 0 ? dataInfo.activityLogInterval : 0L, (com.baidu.mapapi.UIMsg.d_ResultType.LONG_URL & 256) != 0 ? dataInfo.alertsData : null);
        }
