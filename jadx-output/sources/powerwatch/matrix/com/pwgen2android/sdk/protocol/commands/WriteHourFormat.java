...
@kotlin.Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0010\u0012\n\u0000\u0018\u00002\u00020\u0001B\u000f\u0012\b\b\u0002\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\b\u0010\u0005\u001a\u00020\u0006H\u0016R\u000e\u0010\u0002\u001a\u00020\u0003X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u0007"}, d2 = {"Lpowerwatch/matrix/com/pwgen2android/sdk/protocol/commands/WriteHourFormat;", "Lpowerwatch/matrix/com/pwgen2android/sdk/protocol/commands/Command;", "useTwelveHours", "", "(Z)V", "getSendingData", "", "app_release"}, k = 1, mv = {1, 5, 1}, xi = 48)
public final class WriteHourFormat implements powerwatch.matrix.com.pwgen2android.sdk.protocol.commands.Command {
    private final boolean useTwelveHours;

    public WriteHourFormat() {
        this(false, 1, null);
    }

    public WriteHourFormat(boolean z) {
        this.useTwelveHours = z;
    }

    public /* synthetic */ WriteHourFormat(boolean z, int i, kotlin.jvm.internal.DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? false : z);
    }
    ...
    public byte[] getSendingData() {
        return new byte[]{-124, 1, 0, 1 ^ (this.useTwelveHours ? 1 : 0)};
    }
}
