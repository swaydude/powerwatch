...
public final class GetWrittenDataRequest implements powerwatch.matrix.com.pwgen2android.sdk.protocol.commands.Command {
    ...
    public powerwatch.matrix.com.pwgen2android.sdk.protocol.commands.DataInfo parseReceivedData(byte[] dataToParse, powerwatch.matrix.com.pwgen2android.sdk.protocol.commands.DataInfo dataInfo) {
        ...
        if (kotlin.text.StringsKt.startsWith(new java.lang.String(dataToParse, kotlin.text.Charsets.UTF_8), "#QT:Q,1", true)) {
