...
@kotlin.Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0012\n\u0000\u0018\u00002\u00020\u0001B\r\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\b\u0010\u0005\u001a\u00020\u0006H\u0016R\u000e\u0010\u0002\u001a\u00020\u0003X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u0007"}, d2 = {"Lpowerwatch/matrix/com/pwgen2android/sdk/protocol/commands/WriteUserInfoData;", "Lpowerwatch/matrix/com/pwgen2android/sdk/protocol/commands/Command;", "userInfoData", "Lpowerwatch/matrix/com/pwgen2android/sdk/protocol/executors/UserInfoData;", "(Lpowerwatch/matrix/com/pwgen2android/sdk/protocol/executors/UserInfoData;)V", "getSendingData", "", "app_release"}, k = 1, mv = {1, 5, 1}, xi = 48)
public final class WriteUserInfoData implements powerwatch.matrix.com.pwgen2android.sdk.protocol.commands.Command {
    private final powerwatch.matrix.com.pwgen2android.sdk.protocol.executors.UserInfoData userInfoData;

    public WriteUserInfoData(powerwatch.matrix.com.pwgen2android.sdk.protocol.executors.UserInfoData userInfoData) {
    ...
    public byte[] getSendingData() {
        ...
        byteBufferAllocate.put((byte) (!this.userInfoData.getGenderMale() ? 1 : 0));
        byteBufferAllocate.put((byte) this.userInfoData.getAge());
        byteBufferAllocate.putShort((short) kotlin.math.MathKt.roundToInt(this.userInfoData.getWeight()));
        byteBufferAllocate.putShort((short) (this.userInfoData.getHeight() * 10));
        byte[] bArrArray = byteBufferAllocate.array();
        kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(bArrArray, "buffer.array()");
        return kotlin.collections.ArraysKt.plus(new byte[]{-124, 1, 3}, bArrArray);
    }
}
