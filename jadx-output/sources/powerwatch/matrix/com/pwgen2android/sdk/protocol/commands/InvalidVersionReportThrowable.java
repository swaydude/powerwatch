...
public final /* data */ class InvalidVersionReportThrowable extends java.lang.Throwable {
    private final powerwatch.matrix.com.pwgen2android.sdk.protocol.commands.DataInfo dataInfo;

    public static /* synthetic */ powerwatch.matrix.com.pwgen2android.sdk.protocol.commands.InvalidVersionReportThrowable copy$default(powerwatch.matrix.com.pwgen2android.sdk.protocol.commands.InvalidVersionReportThrowable invalidVersionReportThrowable, powerwatch.matrix.com.pwgen2android.sdk.protocol.commands.DataInfo dataInfo, int i, java.lang.Object obj) {
        if ((i & 1) != 0) {
            dataInfo = invalidVersionReportThrowable.dataInfo;
        }
        return invalidVersionReportThrowable.copy(dataInfo);
    }
    ...
    public final powerwatch.matrix.com.pwgen2android.sdk.protocol.commands.InvalidVersionReportThrowable copy(powerwatch.matrix.com.pwgen2android.sdk.protocol.commands.DataInfo dataInfo) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(dataInfo, "dataInfo");
        return new powerwatch.matrix.com.pwgen2android.sdk.protocol.commands.InvalidVersionReportThrowable(dataInfo);
    }
    ...
    public boolean equals(java.lang.Object other) {
        ...
        return (other instanceof powerwatch.matrix.com.pwgen2android.sdk.protocol.commands.InvalidVersionReportThrowable) && kotlin.jvm.internal.Intrinsics.areEqual(this.dataInfo, ((powerwatch.matrix.com.pwgen2android.sdk.protocol.commands.InvalidVersionReportThrowable) other).dataInfo);
    }
    ...
    public java.lang.String toString() {
        return "InvalidVersionReportThrowable(dataInfo=" + this.dataInfo + ')';
    }

    public InvalidVersionReportThrowable(powerwatch.matrix.com.pwgen2android.sdk.protocol.commands.DataInfo dataInfo) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(dataInfo, "dataInfo");
    ...
    public java.lang.String getMessage() {
        ...
        sb.append("Invalid version found after retry: ");
