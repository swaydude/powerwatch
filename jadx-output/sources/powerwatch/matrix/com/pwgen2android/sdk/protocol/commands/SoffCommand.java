...
public final class SoffCommand implements powerwatch.matrix.com.pwgen2android.sdk.protocol.commands.Command {
    ...
    public byte[] getSendingData() {
        return new byte[]{-127, 15, 5, 0, -126};
    }
