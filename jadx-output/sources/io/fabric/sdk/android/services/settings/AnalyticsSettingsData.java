...
public class AnalyticsSettingsData {
    ...
    public AnalyticsSettingsData(java.lang.String str, int i, int i2, int i3, int i4, boolean z, boolean z2, boolean z3, boolean z4, int i5, boolean z5) {
    ...
    public AnalyticsSettingsData(java.lang.String str, int i, int i2, int i3, int i4, boolean z, int i5) {
        this(str, i, i2, i3, i4, false, false, z, true, i5, true);
    }

    @java.lang.Deprecated
    public AnalyticsSettingsData(java.lang.String str, int i, int i2, int i3, int i4, boolean z) {
