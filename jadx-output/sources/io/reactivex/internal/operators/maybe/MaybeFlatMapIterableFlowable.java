...
public final class MaybeFlatMapIterableFlowable<T, R> extends io.reactivex.Flowable<R> {
    ...
    protected void subscribeActual(org.reactivestreams.Subscriber<? super R> subscriber) {
        this.source.subscribe(new io.reactivex.internal.operators.maybe.MaybeFlatMapIterableFlowable.FlatMapIterableObserver(subscriber, this.mapper));
    }
    ...
    static final class FlatMapIterableObserver<T, R> extends io.reactivex.internal.subscriptions.BasicIntQueueSubscription<R> implements io.reactivex.MaybeObserver<T> {
        ...
        void fastPath(org.reactivestreams.Subscriber<? super R> subscriber, java.util.Iterator<? extends R> it) {
