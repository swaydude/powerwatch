...
public final class ObservableSequenceEqual<T> extends io.reactivex.Observable<java.lang.Boolean> {
    ...
    public void subscribeActual(io.reactivex.Observer<? super java.lang.Boolean> observer) {
        io.reactivex.internal.operators.observable.ObservableSequenceEqual.EqualCoordinator equalCoordinator = new io.reactivex.internal.operators.observable.ObservableSequenceEqual.EqualCoordinator(observer, this.bufferSize, this.first, this.second, this.comparer);
