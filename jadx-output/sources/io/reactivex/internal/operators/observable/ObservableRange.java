...
public final class ObservableRange extends io.reactivex.Observable<java.lang.Integer> {
    ...
    protected void subscribeActual(io.reactivex.Observer<? super java.lang.Integer> observer) {
        io.reactivex.internal.operators.observable.ObservableRange.RangeDisposable rangeDisposable = new io.reactivex.internal.operators.observable.ObservableRange.RangeDisposable(observer, this.start, this.end);
