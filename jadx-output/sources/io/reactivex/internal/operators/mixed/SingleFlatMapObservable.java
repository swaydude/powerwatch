...
public final class SingleFlatMapObservable<T, R> extends io.reactivex.Observable<R> {
    ...
    protected void subscribeActual(io.reactivex.Observer<? super R> observer) {
        io.reactivex.internal.operators.mixed.SingleFlatMapObservable.FlatMapObserver flatMapObserver = new io.reactivex.internal.operators.mixed.SingleFlatMapObservable.FlatMapObserver(observer, this.mapper);
