...
public final class ObservableConcatMapMaybe<T, R> extends io.reactivex.Observable<R> {
    ...
    protected void subscribeActual(io.reactivex.Observer<? super R> observer) {
        ...
        this.source.subscribe(new io.reactivex.internal.operators.mixed.ObservableConcatMapMaybe.ConcatMapMaybeMainObserver(observer, this.mapper, this.prefetch, this.errorMode));
    }
    ...
    static final class ConcatMapMaybeMainObserver<T, R> extends java.util.concurrent.atomic.AtomicInteger implements io.reactivex.Observer<T>, io.reactivex.disposables.Disposable {
        ...
        final io.reactivex.internal.operators.mixed.ObservableConcatMapMaybe.ConcatMapMaybeMainObserver.ConcatMapMaybeObserver<R> inner = new io.reactivex.internal.operators.mixed.ObservableConcatMapMaybe.ConcatMapMaybeMainObserver.ConcatMapMaybeObserver<>(this);
        R item;
        final io.reactivex.functions.Function<? super T, ? extends io.reactivex.MaybeSource<? extends R>> mapper;
