...
public final class JobImpl extends kotlinx.coroutines.JobSupport {
    ...
    public /* synthetic */ JobImpl(kotlinx.coroutines.Job job, int i, kotlin.jvm.internal.DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? (kotlinx.coroutines.Job) null : job);
    }
}
