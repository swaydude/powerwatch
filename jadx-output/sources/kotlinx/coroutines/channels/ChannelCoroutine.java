...
public class ChannelCoroutine<E> extends kotlinx.coroutines.AbstractCoroutine<kotlin.Unit> implements kotlinx.coroutines.channels.Channel<E> {
    ...
    static /* synthetic */ java.lang.Object receive$suspendImpl(kotlinx.coroutines.channels.ChannelCoroutine channelCoroutine, kotlin.coroutines.Continuation continuation) {
        return channelCoroutine._channel.receive(continuation);
    }

    static /* synthetic */ java.lang.Object receiveOrNull$suspendImpl(kotlinx.coroutines.channels.ChannelCoroutine channelCoroutine, kotlin.coroutines.Continuation continuation) {
        return channelCoroutine._channel.receiveOrNull(continuation);
    }

    static /* synthetic */ java.lang.Object send$suspendImpl(kotlinx.coroutines.channels.ChannelCoroutine channelCoroutine, java.lang.Object obj, kotlin.coroutines.Continuation continuation) {
    ...
    public ChannelCoroutine(kotlin.coroutines.CoroutineContext parentContext, kotlinx.coroutines.channels.Channel<E> _channel, boolean z) {
    ...
    @Override // kotlinx.coroutines.JobSupport, kotlinx.coroutines.Job
    /* JADX INFO: renamed from: cancel0, reason: merged with bridge method [inline-methods] */
