...
public enum CoroutineStart {
    ...
    public final /* synthetic */ class WhenMappings {
        ...
        static {
            ...
            int[] iArr2 = new int[kotlinx.coroutines.CoroutineStart.values().length];
            $EnumSwitchMapping$1 = iArr2;
            iArr2[kotlinx.coroutines.CoroutineStart.DEFAULT.ordinal()] = 1;
            iArr2[kotlinx.coroutines.CoroutineStart.ATOMIC.ordinal()] = 2;
            iArr2[kotlinx.coroutines.CoroutineStart.UNDISPATCHED.ordinal()] = 3;
            iArr2[kotlinx.coroutines.CoroutineStart.LAZY.ordinal()] = 4;
        }
    }
    ...
    public final <T> void invoke(kotlin.jvm.functions.Function1<? super kotlin.coroutines.Continuation<? super T>, ? extends java.lang.Object> block, kotlin.coroutines.Continuation<? super T> completion) {
    ...
    public final <R, T> void invoke(kotlin.jvm.functions.Function2<? super R, ? super kotlin.coroutines.Continuation<? super T>, ? extends java.lang.Object> block, R receiver, kotlin.coroutines.Continuation<? super T> completion) {
        kotlin.jvm.internal.Intrinsics.checkParameterIsNotNull(block, "block");
        kotlin.jvm.internal.Intrinsics.checkParameterIsNotNull(completion, "completion");
        int i = kotlinx.coroutines.CoroutineStart.WhenMappings.$EnumSwitchMapping$1[ordinal()];
        if (i == 1) {
