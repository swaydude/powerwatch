...
public abstract class EventLoop extends kotlinx.coroutines.CoroutineDispatcher {
    ...
    public long processNextEvent() {
        return !processUnconfinedEvent() ? kotlin.jvm.internal.LongCompanionObject.MAX_VALUE : getNextTime();
    }
    ...
    public final void decrementUseCount(boolean unconfined) {
        ...
        if (!(jDelta == 0)) {
            throw new java.lang.IllegalStateException("Extra decrementUseCount".toString());
        }
        if (this.shared) {
            shutdown();
        }
