...
public final class ConcurrentKt {
    ...
    public static final <T> T withLock(java.util.concurrent.locks.ReentrantLock receiver$0, kotlin.jvm.functions.Function0<? extends T> action) {
        ...
        java.util.concurrent.locks.ReentrantLock reentrantLock = receiver$0;
        reentrantLock.lock();
        try {
    ...
    public static final <E> java.util.Set<E> identitySet(int i) {
        java.util.Set<E> setNewSetFromMap = java.util.Collections.newSetFromMap(new java.util.IdentityHashMap(i));
        kotlin.jvm.internal.Intrinsics.checkExpressionValueIsNotNull(setNewSetFromMap, "Collections.newSetFromMa…ityHashMap(expectedSize))");
