...
public final class LockFreeLinkedListKt {
    ...
    private static final java.lang.Object ALREADY_REMOVED = new kotlinx.coroutines.internal.Symbol("ALREADY_REMOVED");
    private static final java.lang.Object LIST_EMPTY = new kotlinx.coroutines.internal.Symbol("LIST_EMPTY");
    private static final java.lang.Object REMOVE_PREPARED = new kotlinx.coroutines.internal.Symbol("REMOVE_PREPARED");
    ...
    public static final kotlinx.coroutines.internal.LockFreeLinkedListNode unwrap(java.lang.Object receiver$0) {
        kotlinx.coroutines.internal.LockFreeLinkedListNode lockFreeLinkedListNode;
        kotlin.jvm.internal.Intrinsics.checkParameterIsNotNull(receiver$0, "receiver$0");
        kotlinx.coroutines.internal.Removed removed = (kotlinx.coroutines.internal.Removed) (!(receiver$0 instanceof kotlinx.coroutines.internal.Removed) ? null : receiver$0);
        return (removed == null || (lockFreeLinkedListNode = removed.ref) == null) ? (kotlinx.coroutines.internal.LockFreeLinkedListNode) receiver$0 : lockFreeLinkedListNode;
    }
}
