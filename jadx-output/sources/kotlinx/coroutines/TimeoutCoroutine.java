...
class TimeoutCoroutine<U, T extends U> extends kotlinx.coroutines.AbstractCoroutine<T> implements java.lang.Runnable, kotlin.coroutines.Continuation<T>, kotlin.coroutines.jvm.internal.CoroutineStackFrame {
    public final long time;
    public final kotlin.coroutines.Continuation<U> uCont;
    ...
    public TimeoutCoroutine(long j, kotlin.coroutines.Continuation<? super U> uCont) {
    ...
    public kotlin.coroutines.jvm.internal.CoroutineStackFrame getCallerFrame() {
        kotlin.coroutines.Continuation<U> continuation = this.uCont;
        if (!(continuation instanceof kotlin.coroutines.jvm.internal.CoroutineStackFrame)) {
            continuation = null;
        }
        kotlin.coroutines.jvm.internal.CoroutineStackFrame coroutineStackFrame = (kotlin.coroutines.jvm.internal.CoroutineStackFrame) continuation;
    ...
    public void run() {
        cancel(kotlinx.coroutines.TimeoutKt.TimeoutCancellationException(this.time, this));
    }
    ...
    public void onCompletionInternal$kotlinx_coroutines_core(java.lang.Object state, int mode, boolean suppressed) {
        if (state instanceof kotlinx.coroutines.CompletedExceptionally) {
            kotlinx.coroutines.ResumeModeKt.resumeUninterceptedWithExceptionMode(this.uCont, ((kotlinx.coroutines.CompletedExceptionally) state).cause, mode);
        } else {
