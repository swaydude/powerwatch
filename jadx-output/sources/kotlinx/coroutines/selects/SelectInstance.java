...
public interface SelectInstance<R> {
    void disposeOnSelect(kotlinx.coroutines.DisposableHandle handle);

    kotlin.coroutines.Continuation<R> getCompletion();

    boolean isSelected();

    java.lang.Object performAtomicIfNotSelected(kotlinx.coroutines.internal.AtomicDesc desc);

    java.lang.Object performAtomicTrySelect(kotlinx.coroutines.internal.AtomicDesc desc);

    void resumeSelectCancellableWithException(java.lang.Throwable exception);

    boolean trySelect(java.lang.Object idempotent);
}
