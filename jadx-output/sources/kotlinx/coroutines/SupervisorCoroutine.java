...
final class SupervisorCoroutine<R> extends kotlinx.coroutines.AbstractCoroutine<R> {
    ...
    public SupervisorCoroutine(kotlin.coroutines.CoroutineContext parentContext, kotlin.coroutines.Continuation<? super R> uCont) {
