...
public abstract class AbstractCoroutine<T> extends kotlinx.coroutines.JobSupport implements kotlinx.coroutines.Job, kotlin.coroutines.Continuation<T>, kotlinx.coroutines.CoroutineScope {
    ...
    protected void onCompletedExceptionally(java.lang.Throwable exception) {
    ...
    public /* synthetic */ AbstractCoroutine(kotlin.coroutines.CoroutineContext coroutineContext, boolean z, int i, kotlin.jvm.internal.DefaultConstructorMarker defaultConstructorMarker) {
        this(coroutineContext, (i & 2) != 0 ? true : z);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AbstractCoroutine(kotlin.coroutines.CoroutineContext parentContext, boolean z) {
        super(z);
    ...
    public final void initParentJob$kotlinx_coroutines_core() {
        initParentJobInternal$kotlinx_coroutines_core((kotlinx.coroutines.Job) this.parentContext.get(kotlinx.coroutines.Job.INSTANCE));
    }
    ...
    public void onCompletionInternal$kotlinx_coroutines_core(java.lang.Object state, int mode, boolean suppressed) {
        if (state instanceof kotlinx.coroutines.CompletedExceptionally) {
            onCompletedExceptionally(((kotlinx.coroutines.CompletedExceptionally) state).cause);
        } else {
            onCompleted(state);
        }
    }
    ...
    public final void resumeWith(java.lang.Object result) {
        makeCompletingOnce$kotlinx_coroutines_core(kotlinx.coroutines.CompletedExceptionallyKt.toState(result), getDefaultResumeMode$kotlinx_coroutines_core());
    }

    @Override // kotlinx.coroutines.JobSupport
    public final void handleOnCompletionException$kotlinx_coroutines_core(java.lang.Throwable exception) {
        kotlin.jvm.internal.Intrinsics.checkParameterIsNotNull(exception, "exception");
        kotlinx.coroutines.CoroutineExceptionHandlerKt.handleCoroutineException(this.parentContext, exception, this);
    }
    ...
    public final void start(kotlinx.coroutines.CoroutineStart start, kotlin.jvm.functions.Function1<? super kotlin.coroutines.Continuation<? super T>, ? extends java.lang.Object> block) {
