...
public class NestedScrollingChildHelper {
    ...
    public void setNestedScrollingEnabled(boolean z) {
        if (this.mIsNestedScrollingEnabled) {
            androidx.core.view.ViewCompat.stopNestedScroll(this.mView);
        }
    ...
    public boolean startNestedScroll(int i, int i2) {
        ...
        for (android.view.ViewParent parent = this.mView.getParent(); parent != null; parent = parent.getParent()) {
            if (androidx.core.view.ViewParentCompat.onStartNestedScroll(parent, view, this.mView, i, i2)) {
                setNestedScrollingParentForType(i2, parent);
                androidx.core.view.ViewParentCompat.onNestedScrollAccepted(parent, view, this.mView, i, i2);
                return true;
            }
    ...
    public void stopNestedScroll(int i) {
        android.view.ViewParent nestedScrollingParentForType = getNestedScrollingParentForType(i);
        if (nestedScrollingParentForType != null) {
            androidx.core.view.ViewParentCompat.onStopNestedScroll(nestedScrollingParentForType, this.mView, i);
    ...
    private boolean dispatchNestedScrollInternal(int i, int i2, int i3, int i4, int[] iArr, int i5, int[] iArr2) {
        android.view.ViewParent nestedScrollingParentForType;
        int i6;
        int i7;
        int[] iArr3;
        ...
        androidx.core.view.ViewParentCompat.onNestedScroll(nestedScrollingParentForType, this.mView, i, i2, i3, i4, i5, iArr3);
        if (iArr != null) {
            this.mView.getLocationInWindow(iArr);
            iArr[0] = iArr[0] - i6;
            iArr[1] = iArr[1] - i7;
    ...
    public boolean dispatchNestedPreScroll(int i, int i2, int[] iArr, int[] iArr2, int i3) {
        ...
        iArr[0] = 0;
        iArr[1] = 0;
        androidx.core.view.ViewParentCompat.onNestedPreScroll(nestedScrollingParentForType, this.mView, i, i2, iArr, i3);
        if (iArr2 != null) {
            this.mView.getLocationInWindow(iArr2);
            iArr2[0] = iArr2[0] - i4;
            iArr2[1] = iArr2[1] - i5;
    ...
    public boolean dispatchNestedFling(float f, float f2, boolean z) {
        ...
        return androidx.core.view.ViewParentCompat.onNestedFling(nestedScrollingParentForType, this.mView, f, f2, z);
    }
    ...
    public boolean dispatchNestedPreFling(float f, float f2) {
        ...
        return androidx.core.view.ViewParentCompat.onNestedPreFling(nestedScrollingParentForType, this.mView, f, f2);
    }
    ...
    private android.view.ViewParent getNestedScrollingParentForType(int i) {
        if (i == 0) {
    ...
    private void setNestedScrollingParentForType(int i, android.view.ViewParent viewParent) {
        if (i == 0) {
