...
class StateListDrawable extends androidx.appcompat.graphics.drawable.DrawableContainer {
    ...
    static class StateListState extends androidx.appcompat.graphics.drawable.DrawableContainer.DrawableContainerState {
        ...
        StateListState(androidx.appcompat.graphics.drawable.StateListDrawable.StateListState stateListState, androidx.appcompat.graphics.drawable.StateListDrawable stateListDrawable, android.content.res.Resources resources) {
    ...
    StateListDrawable(androidx.appcompat.graphics.drawable.StateListDrawable.StateListState stateListState, android.content.res.Resources resources) {
        setConstantState(new androidx.appcompat.graphics.drawable.StateListDrawable.StateListState(stateListState, this, resources));
        onStateChange(getState());
    }

    StateListDrawable(androidx.appcompat.graphics.drawable.StateListDrawable.StateListState stateListState) {
        if (stateListState != null) {
