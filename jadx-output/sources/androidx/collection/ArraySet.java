...
public final class ArraySet<E> implements java.util.Collection<E>, java.util.Set<E> {
    ...
    private int indexOf(java.lang.Object obj, int i) {
        ...
        int iBinarySearch = androidx.collection.ContainerHelpers.binarySearch(this.mHashes, i2, i);
    ...
    private int indexOfNull() {
        ...
        int iBinarySearch = androidx.collection.ContainerHelpers.binarySearch(this.mHashes, i, 0);
    ...
    public E removeAt(int i) {
        ...
        if (i2 <= 1) {
            ...
            if (iArr.length > 8 && i2 < iArr.length / 3) {
                ...
                if (i < i3) {
                    int i4 = i + 1;
                    java.lang.System.arraycopy(iArr, i4, this.mHashes, i, i3 - i);
                    java.lang.System.arraycopy(objArr, i4, this.mArray, i, this.mSize - i);
                }
            } else {
                int i5 = i2 - 1;
                this.mSize = i5;
                if (i < i5) {
                    ...
                    java.lang.Object[] objArr2 = this.mArray;
                    java.lang.System.arraycopy(objArr2, i6, objArr2, i, this.mSize - i);
                }
    ...
    private androidx.collection.MapCollections<E, E> getCollection() {
        if (this.mCollections == null) {
            this.mCollections = new androidx.collection.MapCollections<E, E>() { // from class: androidx.collection.ArraySet.1
                ...
                protected java.lang.Object colGetEntry(int i, int i2) {
                    return androidx.collection.ArraySet.this.mArray[i];
                }
                ...
                protected void colPut(E e, E e2) {
                    androidx.collection.ArraySet.this.add(e);
                }
