...
public class StaggeredGridLayoutManager extends androidx.recyclerview.widget.RecyclerView.LayoutManager implements androidx.recyclerview.widget.RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    public void onRestoreInstanceState(android.os.Parcelable parcelable) {
        if (parcelable instanceof androidx.recyclerview.widget.StaggeredGridLayoutManager.SavedState) {
            this.mPendingSavedState = (androidx.recyclerview.widget.StaggeredGridLayoutManager.SavedState) parcelable;
            requestLayout();
        }
    }
    ...
    public void onInitializeAccessibilityNodeInfoForItem(androidx.recyclerview.widget.RecyclerView.Recycler recycler, androidx.recyclerview.widget.RecyclerView.State state, android.view.View view, androidx.core.view.accessibility.AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
        ...
        if (this.mOrientation == 0) {
            accessibilityNodeInfoCompat.setCollectionItemInfo(androidx.core.view.accessibility.AccessibilityNodeInfoCompat.CollectionItemInfoCompat.obtain(layoutParams2.getSpanIndex(), layoutParams2.mFullSpan ? this.mSpanCount : 1, -1, -1, false, false));
        } else {
            accessibilityNodeInfoCompat.setCollectionItemInfo(androidx.core.view.accessibility.AccessibilityNodeInfoCompat.CollectionItemInfoCompat.obtain(-1, -1, layoutParams2.getSpanIndex(), layoutParams2.mFullSpan ? this.mSpanCount : 1, false, false));
        }
    }
    ...
    private androidx.recyclerview.widget.StaggeredGridLayoutManager.Span getNextSpan(androidx.recyclerview.widget.LayoutState layoutState) {
        ...
        if (layoutState.mLayoutDirection == 1) {
            ...
            int startAfterPadding = this.mPrimaryOrientation.getStartAfterPadding();
            while (i != i3) {
                androidx.recyclerview.widget.StaggeredGridLayoutManager.Span span2 = this.mSpans[i];
        ...
        int endAfterPadding = this.mPrimaryOrientation.getEndAfterPadding();
        while (i != i3) {
            androidx.recyclerview.widget.StaggeredGridLayoutManager.Span span3 = this.mSpans[i];
    ...
    static class LazySpanLookup {
        ...
        int invalidateAfter(int i) {
            ...
            java.util.Arrays.fill(this.mData, i, i2, -1);
            return i2;
        }
