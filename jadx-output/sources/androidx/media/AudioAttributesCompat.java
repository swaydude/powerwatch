...
public class AudioAttributesCompat implements androidx.versionedparcelable.VersionedParcelable {
    ...
    public static androidx.media.AudioAttributesCompat fromBundle(android.os.Bundle bundle) {
        androidx.media.AudioAttributesImpl audioAttributesImplFromBundle;
        if (android.os.Build.VERSION.SDK_INT >= 21) {
            audioAttributesImplFromBundle = androidx.media.AudioAttributesImplApi21.fromBundle(bundle);
        } else {
            audioAttributesImplFromBundle = androidx.media.AudioAttributesImplBase.fromBundle(bundle);
        }
        if (audioAttributesImplFromBundle == null) {
            return null;
        }
        return new androidx.media.AudioAttributesCompat(audioAttributesImplFromBundle);
    }
    ...
    public static class Builder {
        ...
        public androidx.media.AudioAttributesCompat.Builder setFlags(int i) {
            this.mFlags = (i & androidx.media.AudioAttributesCompat.FLAG_ALL) | this.mFlags;
            return this;
        }
