...
public class KeyPosition extends androidx.constraintlayout.motion.widget.KeyPositionBase {
    ...
    void positionScreenAttributes(android.view.View view, android.graphics.RectF rectF, android.graphics.RectF rectF2, float f, float f2, java.lang.String[] strArr, float[] fArr) {
        rectF.centerX();
        rectF.centerY();
        rectF2.centerX();
        rectF2.centerY();
            ...
            for (int i = 0; i < indexCount; i++) {
                ...
                switch (mAttrMap.get(index)) {
                    ...
                    case 12:
                        ...
                        break;
                    default:
                        android.util.Log.e("KeyPosition", "unused attribute 0x" + java.lang.Integer.toHexString(index) + "   " + mAttrMap.get(index));
                        break;
                }
            }
