...
public class StopLogic extends androidx.constraintlayout.motion.widget.MotionInterpolator {
    ...
    public void debug(java.lang.String str, java.lang.String str2, float f) {
        android.util.Log.v(str, str2 + " ===== " + this.mType);
        ...
        android.util.Log.v(str, str2 + " dur " + this.mStage1Duration + " vel " + this.mStage1Velocity + " pos " + this.mStage1EndPosition);
        if (this.mNumberOfStages > 1) {
            android.util.Log.v(str, str2 + " dur " + this.mStage2Duration + " vel " + this.mStage2Velocity + " pos " + this.mStage2EndPosition);
        }
        if (this.mNumberOfStages > 2) {
            android.util.Log.v(str, str2 + " dur " + this.mStage3Duration + " vel " + this.mStage3Velocity + " pos " + this.mStage3EndPosition);
        }
        float f2 = this.mStage1Duration;
        if (f <= f2) {
            android.util.Log.v(str, str2 + "stage 0");
            return;
        }
        int i = this.mNumberOfStages;
        if (i == 1) {
            android.util.Log.v(str, str2 + "end stage 0");
            return;
        }
        float f3 = f - f2;
        float f4 = this.mStage2Duration;
        if (f3 < f4) {
            android.util.Log.v(str, str2 + " stage 1");
            return;
        }
        if (i == 2) {
            android.util.Log.v(str, str2 + "end stage 1");
            return;
        }
        if (f3 - f4 < this.mStage3Duration) {
            android.util.Log.v(str, str2 + " stage 2");
            return;
        }
        android.util.Log.v(str, str2 + " end stage 2");
    }
