...
public class Oscillator {
    ...
    public double getValue(double d) {
        ...
        switch (this.mType) {
            ...
            case 2:
                dAbs = java.lang.Math.abs((((getP(d) * 4.0d) + 1.0d) % 4.0d) - 2.0d);
                break;
            case 3:
            ...
            case 6:
                double dAbs2 = 1.0d - java.lang.Math.abs(((getP(d) * 4.0d) % 4.0d) - 2.0d);
                dAbs = dAbs2 * dAbs2;
                break;
            default:
    ...
    public double getSlope(double d) {
        ...
        switch (this.mType) {
            ...
            case 2:
                dp = getDP(d) * 4.0d;
                dSignum = java.lang.Math.signum((((getP(d) * 4.0d) + 3.0d) % 4.0d) - 2.0d);
                return dp * dSignum;
            case 3:
                dp2 = getDP(d);
                return dp2 * 2.0d;
            ...
            case 5:
                ...
                dSin = java.lang.Math.sin(this.PI2 * getP(d));
                return dp3 * dSin;
            case 6:
                dp = getDP(d) * 4.0d;
            ...
            default:
                dp3 = this.PI2 * getDP(d);
                dSin = java.lang.Math.cos(this.PI2 * getP(d));
                return dp3 * dSin;
        }
    }
}
