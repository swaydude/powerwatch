...
public abstract class CurveFit {
    ...
    public static androidx.constraintlayout.motion.utils.CurveFit get(int i, double[] dArr, double[][] dArr2) {
        ...
        if (i == 0) {
            return new androidx.constraintlayout.motion.utils.MonotonicCurveFit(dArr, dArr2);
        }
        if (i == 2) {
            return new androidx.constraintlayout.motion.utils.CurveFit.Constant(dArr[0], dArr2[0]);
        }
        return new androidx.constraintlayout.motion.utils.LinearCurveFit(dArr, dArr2);
    }
    ...
    static class Constant extends androidx.constraintlayout.motion.utils.CurveFit {
        double mTime;
        double[] mValue;
