...
public class MonotonicCurveFit extends androidx.constraintlayout.motion.utils.CurveFit {
    ...
    public MonotonicCurveFit(double[] dArr, double[][] dArr2) {
        ...
        int i = length - 1;
        double[][] dArr3 = (double[][]) java.lang.reflect.Array.newInstance((java.lang.Class<?>) double.class, i, length2);
        double[][] dArr4 = (double[][]) java.lang.reflect.Array.newInstance((java.lang.Class<?>) double.class, length, length2);
        ...
        for (int i5 = 0; i5 < i; i5++) {
            for (int i6 = 0; i6 < length2; i6++) {
                if (dArr3[i5][i6] == 0.0d) {
                    ...
                    double dHypot = java.lang.Math.hypot(d, d2);
                    if (dHypot > 9.0d) {
