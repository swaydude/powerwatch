...
class ArcCurveFit extends androidx.constraintlayout.motion.utils.CurveFit {
    ...
    public void getPos(double d, double[] dArr) {
        ...
        int i = 0;
        while (true) {
            androidx.constraintlayout.motion.utils.ArcCurveFit.Arc[] arcArr3 = this.mArcs;
            if (i >= arcArr3.length) {
                return;
            }
    ...
    public ArcCurveFit(int[] iArr, double[] dArr, double[][] dArr2) {
        ...
        while (true) {
            ...
            int i5 = i + 1;
            arcArr[i] = new androidx.constraintlayout.motion.utils.ArcCurveFit.Arc(i3, dArr[i], dArr[i5], dArr2[i][0], dArr2[i][1], dArr2[i5][0], dArr2[i5][1]);
            i = i5;
        }
    }
