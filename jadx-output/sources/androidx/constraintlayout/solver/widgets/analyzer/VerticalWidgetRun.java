...
public class VerticalWidgetRun extends androidx.constraintlayout.solver.widgets.analyzer.WidgetRun {
    ...
    public VerticalWidgetRun(androidx.constraintlayout.solver.widgets.ConstraintWidget constraintWidget) {
        ...
        this.baseline = new androidx.constraintlayout.solver.widgets.analyzer.DependencyNode(this);
        ...
        this.baseline.type = androidx.constraintlayout.solver.widgets.analyzer.DependencyNode.Type.BASELINE;
        this.orientation = 1;
    }
    ...
    public void update(androidx.constraintlayout.solver.widgets.analyzer.Dependency dependency) {
        ...
        if (this.dimension.readyToSolve && !this.dimension.resolved && this.dimensionBehavior == androidx.constraintlayout.solver.widgets.ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT) {
        ...
        if (this.start.readyToSolve && this.end.readyToSolve) {
            ...
            if (!this.dimension.resolved && this.dimensionBehavior == androidx.constraintlayout.solver.widgets.ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT && this.widget.mMatchConstraintDefaultWidth == 0 && !this.widget.isInVerticalChain()) {
                androidx.constraintlayout.solver.widgets.analyzer.DependencyNode dependencyNode = this.start.targets.get(0);
                androidx.constraintlayout.solver.widgets.analyzer.DependencyNode dependencyNode2 = this.end.targets.get(0);
            ...
            if (this.dimension.resolved && this.start.targets.size() > 0 && this.end.targets.size() > 0) {
                androidx.constraintlayout.solver.widgets.analyzer.DependencyNode dependencyNode4 = this.start.targets.get(0);
                androidx.constraintlayout.solver.widgets.analyzer.DependencyNode dependencyNode5 = this.end.targets.get(0);
    ...
    void apply() {
        ...
        if (!this.dimension.resolved) {
            ...
            if (this.dimensionBehavior != androidx.constraintlayout.solver.widgets.ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT) {
                if (this.dimensionBehavior == androidx.constraintlayout.solver.widgets.ConstraintWidget.DimensionBehaviour.MATCH_PARENT && (parent2 = this.widget.getParent()) != null && parent2.getVerticalDimensionBehaviour() == androidx.constraintlayout.solver.widgets.ConstraintWidget.DimensionBehaviour.FIXED) {
        ...
        if (this.dimension.resolved && this.widget.measured) {
            ...
            if (this.widget.mListAnchors[2].mTarget != null) {
                androidx.constraintlayout.solver.widgets.analyzer.DependencyNode target3 = getTarget(this.widget.mListAnchors[2]);
                if (target3 != null) {
            ...
            if (this.widget.mListAnchors[3].mTarget != null) {
                androidx.constraintlayout.solver.widgets.analyzer.DependencyNode target4 = getTarget(this.widget.mListAnchors[3]);
                if (target4 != null) {
            ...
            if (this.widget.mListAnchors[4].mTarget != null) {
                androidx.constraintlayout.solver.widgets.analyzer.DependencyNode target5 = getTarget(this.widget.mListAnchors[4]);
                if (target5 != null) {
        ...
        if (!this.dimension.resolved && this.dimensionBehavior == androidx.constraintlayout.solver.widgets.ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT) {
            ...
            if (i != 2) {
                if (i == 3 && !this.widget.isInVerticalChain() && this.widget.mMatchConstraintDefaultWidth != 3) {
                    androidx.constraintlayout.solver.widgets.analyzer.DimensionDependency dimensionDependency = this.widget.horizontalRun.dimension;
        ...
        if (this.widget.mListAnchors[2].mTarget != null && this.widget.mListAnchors[3].mTarget != null) {
            ...
            androidx.constraintlayout.solver.widgets.analyzer.DependencyNode target8 = getTarget(this.widget.mListAnchors[2]);
            if (target8 != null) {
                ...
                if (this.dimensionBehavior == androidx.constraintlayout.solver.widgets.ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT && this.widget.getDimensionRatio() > 0.0f && this.widget.horizontalRun.dimensionBehavior == androidx.constraintlayout.solver.widgets.ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT) {
            ...
            androidx.constraintlayout.solver.widgets.analyzer.DependencyNode target9 = getTarget(this.widget.mListAnchors[3]);
            if (target9 != null) {
            ...
            androidx.constraintlayout.solver.widgets.analyzer.DependencyNode target10 = getTarget(this.widget.mListAnchors[4]);
            if (target10 != null) {
