...
public class ChainRun extends androidx.constraintlayout.solver.widgets.analyzer.WidgetRun {
    ...
    private void build() {
        ...
        for (androidx.constraintlayout.solver.widgets.analyzer.WidgetRun widgetRun : this.widgets) {
    ...
    public void update(androidx.constraintlayout.solver.widgets.analyzer.Dependency dependency) {
        ...
        if (this.start.resolved && this.end.resolved) {
            ...
            boolean zIsRtl = (parent == null || !(parent instanceof androidx.constraintlayout.solver.widgets.ConstraintWidgetContainer)) ? false : ((androidx.constraintlayout.solver.widgets.ConstraintWidgetContainer) parent).isRtl();
            ...
            while (true) {
                ...
                f = 0.0f;
                while (i16 < size) {
                    androidx.constraintlayout.solver.widgets.analyzer.WidgetRun widgetRun = this.widgets.get(i16);
                    if (widgetRun.widget.getVisibility() != i2) {
                        ...
                        boolean z = widgetRun.dimensionBehavior != androidx.constraintlayout.solver.widgets.ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT;
                        if (z) {
            ...
            if (i5 > 0) {
                ...
                int i22 = 0;
                while (i21 < size) {
                    androidx.constraintlayout.solver.widgets.analyzer.WidgetRun widgetRun2 = this.widgets.get(i21);
                    int i23 = i20;
                    if (widgetRun2.widget.getVisibility() == 8 || widgetRun2.dimensionBehavior != androidx.constraintlayout.solver.widgets.ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT || widgetRun2.dimension.resolved) {
                        i9 = i19;
                        f2 = f4;
                        i10 = i4;
                    } else {
                        ...
                        if (this.orientation == 0) {
                            ...
                            i10 = i4;
                            i9 = i19;
                            int iMax = java.lang.Math.max(widgetRun2.widget.mMatchConstraintMinWidth, widgetRun2.matchConstraintsType == 1 ? java.lang.Math.min(i24, widgetRun2.dimension.wrapValue) : i24);
                            if (i25 > 0) {
                                iMax = java.lang.Math.min(i25, iMax);
                            }
                            if (iMax != i24) {
                                i22++;
                                i24 = iMax;
                            ...
                            int iMax2 = java.lang.Math.max(widgetRun2.widget.mMatchConstraintMinHeight, widgetRun2.matchConstraintsType == 1 ? java.lang.Math.min(i24, widgetRun2.dimension.wrapValue) : i24);
                            if (i26 > 0) {
                                iMax2 = java.lang.Math.min(i26, iMax2);
                            }
                            if (iMax2 != i24) {
                                i22++;
                                i24 = iMax2;
                ...
                if (i22 > 0) {
                    ...
                    for (int i29 = 0; i29 < size; i29++) {
                        androidx.constraintlayout.solver.widgets.analyzer.WidgetRun widgetRun3 = this.widgets.get(i29);
            ...
            if (i30 == 1) {
                ...
                for (int i32 = 0; i32 < size; i32++) {
                    androidx.constraintlayout.solver.widgets.analyzer.WidgetRun widgetRun4 = this.widgets.get(zIsRtl ? size - (i32 + 1) : i32);
            ...
            if (i30 == 0) {
                ...
                for (int i36 = 0; i36 < size; i36++) {
                    androidx.constraintlayout.solver.widgets.analyzer.WidgetRun widgetRun5 = this.widgets.get(zIsRtl ? size - (i36 + 1) : i36);
            ...
            if (i30 == 2) {
                ...
                for (int i40 = 0; i40 < size; i40++) {
                    androidx.constraintlayout.solver.widgets.analyzer.WidgetRun widgetRun6 = this.widgets.get(zIsRtl ? size - (i40 + 1) : i40);
