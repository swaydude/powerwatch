...
public class ArrayLinkedVariables {
    ...
    ArrayLinkedVariables(androidx.constraintlayout.solver.ArrayRow arrayRow, androidx.constraintlayout.solver.Cache cache) {
        this.mRow = arrayRow;
        this.mCache = cache;
    }
    ...
    final void add(androidx.constraintlayout.solver.SolverVariable solverVariable, float f, boolean z) {
        if (f == 0.0f) {
            return;
        }
        int i = this.mHead;
    ...
    final boolean containsKey(androidx.constraintlayout.solver.SolverVariable solverVariable) {
        int i = this.mHead;
        if (i == -1) {
            return false;
        }
    ...
    androidx.constraintlayout.solver.SolverVariable chooseSubject(androidx.constraintlayout.solver.LinearSystem linearSystem) {
        int i = this.mHead;
        ...
        for (int i2 = 0; i != -1 && i2 < this.currentSize; i2++) {
            ...
            if (f3 != 0.0f) {
                if (solverVariable3.mType == androidx.constraintlayout.solver.SolverVariable.Type.UNRESTRICTED) {
    ...
    final void updateFromRow(androidx.constraintlayout.solver.ArrayRow arrayRow, androidx.constraintlayout.solver.ArrayRow arrayRow2, boolean z) {
        int i = this.mHead;
        while (true) {
            for (int i2 = 0; i != -1 && i2 < this.currentSize; i2++) {
                if (this.mArrayIndices[i] == arrayRow2.variable.id) {
                    ...
                    androidx.constraintlayout.solver.ArrayLinkedVariables arrayLinkedVariables = arrayRow2.variables;
    ...
    void updateFromSystem(androidx.constraintlayout.solver.ArrayRow arrayRow, androidx.constraintlayout.solver.ArrayRow[] arrayRowArr) {
        int i = this.mHead;
        while (true) {
            for (int i2 = 0; i != -1 && i2 < this.currentSize; i2++) {
                androidx.constraintlayout.solver.SolverVariable solverVariable = this.mCache.mIndexedVariables[this.mArrayIndices[i]];
                if (solverVariable.definitionId != -1) {
                    float f = this.mArrayValues[i];
                    remove(solverVariable, true);
                    androidx.constraintlayout.solver.ArrayRow arrayRow2 = arrayRowArr[solverVariable.definitionId];
    ...
    androidx.constraintlayout.solver.SolverVariable getPivotCandidate(boolean[] zArr, androidx.constraintlayout.solver.SolverVariable solverVariable) {
        int i = this.mHead;
        androidx.constraintlayout.solver.SolverVariable solverVariable2 = null;
        float f = 0.0f;
        for (int i2 = 0; i != -1 && i2 < this.currentSize; i2++) {
            if (this.mArrayValues[i] < 0.0f) {
                androidx.constraintlayout.solver.SolverVariable solverVariable3 = this.mCache.mIndexedVariables[this.mArrayIndices[i]];
                if ((zArr == null || !zArr[solverVariable3.id]) && solverVariable3 != solverVariable && (solverVariable3.mType == androidx.constraintlayout.solver.SolverVariable.Type.SLACK || solverVariable3.mType == androidx.constraintlayout.solver.SolverVariable.Type.ERROR)) {
    ...
    final androidx.constraintlayout.solver.SolverVariable getVariable(int i) {
        int i2 = this.mHead;
