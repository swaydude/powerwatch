...
final class SegmentedByteString extends okio.ByteString {
    ...
    SegmentedByteString(okio.Buffer buffer, int i) {
        super(null);
    ...
    private int segment(int i) {
        int iBinarySearch = java.util.Arrays.binarySearch(this.directory, 0, this.segments.length, i + 1);
    ...
    public boolean rangeEquals(int i, okio.ByteString byteString, int i2, int i3) {
        ...
        while (i3 > 0) {
            ...
            int iMin = java.lang.Math.min(i3, ((this.directory[iSegment] - i4) + i4) - i);
            int[] iArr = this.directory;
            byte[][] bArr = this.segments;
    ...
    public boolean rangeEquals(int i, byte[] bArr, int i2, int i3) {
        ...
        while (i3 > 0) {
            ...
            if (!okio.Util.arrayRangeEquals(bArr2[iSegment], (i - i4) + iArr[bArr2.length + iSegment], bArr, i2, iMin)) {
                return false;
            }
            i += iMin;
            i2 += iMin;
