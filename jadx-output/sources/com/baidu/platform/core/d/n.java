...
public class n extends com.baidu.platform.base.e {
    public n(com.baidu.mapapi.search.route.TransitRoutePlanOption transitRoutePlanOption) {
        a(transitRoutePlanOption);
    }

    private void a(com.baidu.mapapi.search.route.TransitRoutePlanOption transitRoutePlanOption) {
        this.a.a("qt", "bus");
        ...
        if (com.baidu.mapapi.search.route.TransitRoutePlanOption.TransitPolicy.EBUS_NO_SUBWAY == transitRoutePlanOption.mPolicy) {
