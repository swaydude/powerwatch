...
public class a extends com.baidu.mapsdkplatform.comapi.a.c {
    ...
    android.animation.ObjectAnimator a(com.baidu.mapapi.map.Marker marker) {
        android.animation.ObjectAnimator objectAnimatorOfFloat = android.animation.ObjectAnimator.ofFloat(marker, "alpha", this.g);
    ...
    protected void a(android.animation.Animator animator) {
        ...
        animator.addListener(new com.baidu.mapsdkplatform.comapi.a.b(this));
    }
