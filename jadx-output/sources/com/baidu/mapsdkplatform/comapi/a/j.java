...
public class j extends com.baidu.mapsdkplatform.comapi.a.c {
    ...
    android.animation.ObjectAnimator a(com.baidu.mapapi.map.Marker marker) {
        ...
        int i = this.h;
        if (i == 1) {
            objectAnimatorOfFloat = android.animation.ObjectAnimator.ofFloat(marker, "scaleX", this.g);
        } else {
            objectAnimatorOfFloat = i == 2 ? android.animation.ObjectAnimator.ofFloat(marker, "scaleY", this.g) : null;
        }
    ...
    protected void a(android.animation.Animator animator) {
        ...
        animator.addListener(new com.baidu.mapsdkplatform.comapi.a.k(this));
    }
