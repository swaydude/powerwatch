...
class u implements com.baidu.mapsdkplatform.comapi.map.h.a {
    ...
    final /* synthetic */ com.baidu.mapapi.map.TextureMapView c;

    u(com.baidu.mapapi.map.TextureMapView textureMapView, com.baidu.mapapi.map.MapView.CustomMapStyleCallBack customMapStyleCallBack, com.baidu.mapapi.map.MapCustomStyleOptions mapCustomStyleOptions) {
    ...
    public void a(boolean z, java.lang.String str) {
        com.baidu.mapapi.map.MapView.CustomMapStyleCallBack customMapStyleCallBack = this.a;
        if ((customMapStyleCallBack == null || !customMapStyleCallBack.onCustomMapStyleLoadSuccess(z, str)) && !android.text.TextUtils.isEmpty(str)) {
            this.c.a(str, 1);
            this.c.setMapCustomStyleEnable(true);
        }
    }
