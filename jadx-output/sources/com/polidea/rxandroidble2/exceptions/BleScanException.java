...
public class BleScanException extends com.polidea.rxandroidble2.exceptions.BleException {
    ...
    private final java.util.Date retryDateSuggestion;
    ...
    public BleScanException(int i, java.util.Date date) {
        super(createMessage(i, date));
        this.reason = i;
        this.retryDateSuggestion = date;
    }

    public BleScanException(int i, java.lang.Throwable th) {
    ...
    public java.util.Date getRetryDateSuggestion() {
        return this.retryDateSuggestion;
    }

    private static java.lang.String createMessage(int i, java.util.Date date) {
        return reasonDescription(i) + " (code " + i + ")" + retryDateSuggestionIfExists(date);
    }

    private static java.lang.String retryDateSuggestionIfExists(java.util.Date date) {
        if (date == null) {
            return "";
        }
