...
public class JsonReader implements java.io.Closeable {
    ...
    public JsonReader(java.io.Reader reader) {
        ...
        java.util.Objects.requireNonNull(reader, "in == null");
        this.in = reader;
    }
    ...
    /* JADX WARN: Code duplicated, block: B:111:0x00fb A[SYNTHETIC] */
    /* JADX WARN: Code duplicated, block: B:14:0x0031  */
    /* JADX WARN: Code duplicated, block: B:91:0x00e4  */
    /* JADX WARN: Code duplicated, block: B:93:0x00e9  */
    /* JADX WARN: Code duplicated, block: B:98:0x00f0  */
    ...
    public java.lang.String nextName() throws java.io.IOException {
        ...
        if (iDoPeek == 14) {
            ...
            strNextQuotedValue = nextQuotedValue(kotlin.text.Typography.quote);
        } else {
    ...
    public double nextDouble() throws java.io.IOException {
        ...
        if (iDoPeek == 16) {
            ...
            this.peekedString = nextQuotedValue(iDoPeek == 8 ? '\'' : kotlin.text.Typography.quote);
        } else if (iDoPeek == 10) {
        ...
        this.peeked = 11;
        double d = java.lang.Double.parseDouble(this.peekedString);
        if (!this.lenient && (java.lang.Double.isNaN(d) || java.lang.Double.isInfinite(d))) {
            throw new com.google.gson.stream.MalformedJsonException("JSON forbids NaN and infinities: " + d + locationString());
        }
        this.peekedString = null;
        this.peeked = 0;
        int[] iArr2 = this.pathIndices;
    ...
    private java.lang.String nextUnquotedValue() throws java.io.IOException {
        ...
        while (true) {
            ...
            while (true) {
                ...
                if (sb == null) {
                    string = new java.lang.String(this.buffer, this.pos, i);
                } else {
