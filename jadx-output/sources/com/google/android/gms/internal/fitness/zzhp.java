...
final class zzhp {
    static java.lang.String zza(com.google.android.gms.internal.fitness.zzho zzhoVar, java.lang.String str) {
    ...
    private static void zza(com.google.android.gms.internal.fitness.zzho zzhoVar, java.lang.StringBuilder sb, int i) {
        boolean zEquals;
        java.util.HashMap map = new java.util.HashMap();
        java.util.HashMap map2 = new java.util.HashMap();
        java.util.TreeSet<java.lang.String> treeSet = new java.util.TreeSet();
        for (java.lang.reflect.Method method : zzhoVar.getClass().getDeclaredMethods()) {
        ...
        for (java.lang.String str : treeSet) {
            ...
            if (strReplaceFirst.endsWith("List") && !strReplaceFirst.endsWith("OrBuilderList") && !strReplaceFirst.equals("List")) {
                ...
                if (method2 != null && method2.getReturnType().equals(java.util.List.class)) {
                    zza(sb, i, zzo(strConcat), com.google.android.gms.internal.fitness.zzgg.zza(method2, zzhoVar, new java.lang.Object[0]));
                }
            }
            if (strReplaceFirst.endsWith("Map") && !strReplaceFirst.equals("Map")) {
                ...
                if (method3 != null && method3.getReturnType().equals(java.util.Map.class) && !method3.isAnnotationPresent(java.lang.Deprecated.class) && java.lang.reflect.Modifier.isPublic(method3.getModifiers())) {
                    zza(sb, i, zzo(strConcat2), com.google.android.gms.internal.fitness.zzgg.zza(method3, zzhoVar, new java.lang.Object[0]));
                }
            }
            ...
            if (((java.lang.reflect.Method) map2.get(strValueOf5.length() != 0 ? "set".concat(strValueOf5) : new java.lang.String("set"))) != null) {
                ...
                if (method4 != null) {
                    java.lang.Object objZza = com.google.android.gms.internal.fitness.zzgg.zza(method4, zzhoVar, new java.lang.Object[0]);
                    if (method5 == null) {
                        ...
                        } else if (objZza instanceof com.google.android.gms.internal.fitness.zzff) {
                            zEquals = objZza.equals(com.google.android.gms.internal.fitness.zzff.zzri);
                        } else if (!(objZza instanceof com.google.android.gms.internal.fitness.zzho) ? !((objZza instanceof java.lang.Enum) && ((java.lang.Enum) objZza).ordinal() == 0) : objZza != ((com.google.android.gms.internal.fitness.zzho) objZza).zzbm()) {
                            zEquals = false;
                        } else {
                            zEquals = true;
                        }
                        ...
                        zBooleanValue = ((java.lang.Boolean) com.google.android.gms.internal.fitness.zzgg.zza(method5, zzhoVar, new java.lang.Object[0])).booleanValue();
                    }
                    if (zBooleanValue) {
        ...
        if (zzhoVar instanceof com.google.android.gms.internal.fitness.zzgg.zzd) {
            java.util.Iterator<java.util.Map.Entry<T, java.lang.Object>> it = ((com.google.android.gms.internal.fitness.zzgg.zzd) zzhoVar).zzvi.iterator();
            if (it.hasNext()) {
                throw new java.lang.NoSuchMethodError();
            }
        }
        com.google.android.gms.internal.fitness.zzgg zzggVar = (com.google.android.gms.internal.fitness.zzgg) zzhoVar;
        if (zzggVar.zzvb != null) {
            zzggVar.zzvb.zza(sb, i);
        }
    }
    ...
    static final void zza(java.lang.StringBuilder sb, int i, java.lang.String str, java.lang.Object obj) {
        ...
        if (obj instanceof java.lang.String) {
            sb.append(": \"");
            sb.append(com.google.android.gms.internal.fitness.zziq.zzc(com.google.android.gms.internal.fitness.zzff.zzl((java.lang.String) obj)));
            sb.append(kotlin.text.Typography.quote);
            return;
        }
        if (obj instanceof com.google.android.gms.internal.fitness.zzff) {
            sb.append(": \"");
            sb.append(com.google.android.gms.internal.fitness.zziq.zzc((com.google.android.gms.internal.fitness.zzff) obj));
            sb.append(kotlin.text.Typography.quote);
            return;
        }
        if (obj instanceof com.google.android.gms.internal.fitness.zzgg) {
            sb.append(" {");
            zza((com.google.android.gms.internal.fitness.zzgg) obj, sb, i + 2);
            sb.append("\n");
            while (i2 < i) {
                sb.append(' ');
                i2++;
