...
final class zzje extends com.google.android.gms.internal.fitness.zzjb {
    zzje() {
    }
        ...
        while (i2 < i3) {
            ...
            if (b < 0) {
                ...
                if (b >= -16) {
                    ...
                    return com.google.android.gms.internal.fitness.zzjc.zzd(bArr, i4, i3);
                }
                if (i4 < i3 - 1) {
                    int i7 = i4 + 1;
                    byte b3 = bArr[i4];
                ...
                if (cCharAt2 < 2048 && i8 <= i6 - 2) {
                    ...
                    if ((cCharAt2 >= 55296 && 57343 >= cCharAt2) || i8 > i6 - 3) {
                        if (i8 <= i6 - 4) {
                            ...
                            throw new com.google.android.gms.internal.fitness.zzjd(i7 - 1, length);
                        }
                        if (55296 <= cCharAt2 && cCharAt2 <= 57343 && ((i4 = i7 + 1) == charSequence.length() || !java.lang.Character.isSurrogatePair(cCharAt2, charSequence.charAt(i4)))) {
                            throw new com.google.android.gms.internal.fitness.zzjd(i7, length);
                        }
