...
final class zzii extends com.google.android.gms.internal.measurement.zzif {
    zzii() {
    }
        ...
        while (i2 < i3) {
            ...
            if (b < 0) {
                ...
                if (b >= -16) {
                    ...
                    return com.google.android.gms.internal.measurement.zzie.zzd(bArr, i4, i3);
                }
                if (i4 < i3 - 1) {
                    int i7 = i4 + 1;
                    byte b3 = bArr[i4];
    ...
    final java.lang.String zzb(byte[] bArr, int i, int i2) throws com.google.android.gms.internal.measurement.zzfo {
        ...
        while (i < i3) {
            byte b = bArr[i];
            if (!com.google.android.gms.internal.measurement.zzig.zzd(b)) {
                break;
            }
            i++;
            com.google.android.gms.internal.measurement.zzig.zzb(b, cArr, i4);
            i4++;
        }
        int i5 = i4;
        while (i < i3) {
            int i6 = i + 1;
            byte b2 = bArr[i];
            if (com.google.android.gms.internal.measurement.zzig.zzd(b2)) {
                int i7 = i5 + 1;
                com.google.android.gms.internal.measurement.zzig.zzb(b2, cArr, i5);
                while (i6 < i3) {
                    byte b3 = bArr[i6];
                    if (!com.google.android.gms.internal.measurement.zzig.zzd(b3)) {
                        break;
                    }
                    i6++;
                    com.google.android.gms.internal.measurement.zzig.zzb(b3, cArr, i7);
                    i7++;
                }
                i = i6;
                i5 = i7;
            } else if (com.google.android.gms.internal.measurement.zzig.zze(b2)) {
                if (i6 < i3) {
                    com.google.android.gms.internal.measurement.zzig.zzb(b2, bArr[i6], cArr, i5);
                    i = i6 + 1;
                    i5++;
                } else {
                    throw com.google.android.gms.internal.measurement.zzfo.zzh();
                }
            } else if (com.google.android.gms.internal.measurement.zzig.zzf(b2)) {
                if (i6 < i3 - 1) {
                    int i8 = i6 + 1;
                    com.google.android.gms.internal.measurement.zzig.zzb(b2, bArr[i6], bArr[i8], cArr, i5);
                    i = i8 + 1;
                    i5++;
                } else {
                    throw com.google.android.gms.internal.measurement.zzfo.zzh();
                ...
                byte b4 = bArr[i6];
                int i10 = i9 + 1;
                com.google.android.gms.internal.measurement.zzig.zzb(b2, b4, bArr[i9], bArr[i10], cArr, i5);
                i = i10 + 1;
                i5 = i5 + 1 + 1;
            }
        }
                ...
                if (cCharAt2 < 2048 && i8 <= i6 - 2) {
                    ...
                    if ((cCharAt2 >= 55296 && 57343 >= cCharAt2) || i8 > i6 - 3) {
                        if (i8 <= i6 - 4) {
                            ...
                            throw new com.google.android.gms.internal.measurement.zzih(i7 - 1, length);
                        }
                        if (55296 <= cCharAt2 && cCharAt2 <= 57343 && ((i4 = i7 + 1) == charSequence.length() || !java.lang.Character.isSurrogatePair(cCharAt2, charSequence.charAt(i4)))) {
                            throw new com.google.android.gms.internal.measurement.zzih(i7, length);
                        }
