...
public class Bounds {
    ...
    public boolean contains(com.google.maps.android.geometry.Point point) {
    ...
    public boolean intersects(com.google.maps.android.geometry.Bounds bounds) {
        return intersects(bounds.minX, bounds.maxX, bounds.minY, bounds.maxY);
    }

    public boolean contains(com.google.maps.android.geometry.Bounds bounds) {
