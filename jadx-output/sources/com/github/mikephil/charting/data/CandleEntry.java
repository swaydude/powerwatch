...
public class CandleEntry extends com.github.mikephil.charting.data.Entry {
    ...
    public float getShadowRange() {
        return java.lang.Math.abs(this.mShadowHigh - this.mShadowLow);
    }

    public float getBodyRange() {
        return java.lang.Math.abs(this.mOpen - this.mClose);
    }
    ...
    public com.github.mikephil.charting.data.CandleEntry copy() {
        return new com.github.mikephil.charting.data.CandleEntry(getX(), this.mShadowHigh, this.mShadowLow, this.mOpen, this.mClose, getData());
    }
